            ...
            var l = n.a.component("i-frame", {
                    ...
                    methods: {
                        renderChildren: function() {
                            ...
                            u.name = "viewport", u.content = "width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no", r.appendChild(p), r.appendChild(u);
                        ...
                        reInjectCSSGlobalVariables: function() {
                            ...
                            if (this.$store.getters["browserData/mobileBrowserName"]) {
                                var r, a = null === (r = this.$TawkJSAPI) || void 0 === r || null === (r = r.local_API) || void 0 === r || null === (r = r.customStyle) || void 0 === r ? void 0 : r.visibility;
                                a && a.mobile && a.mobile.maximized && (a.mobile.maximized.paddingTop && (o = "".concat(a.mobile.maximized.paddingTop, "px")), a.mobile.maximized.paddingBottom && (n = "".concat(a.mobile.maximized.paddingBottom, "px")))
                            }
                            var i = document.createElement("style");
                            i.type = "text/css", i.classList.add("tawk-global-variables");
                            var s = ":root {\n\t\t\t\t\t--tawk-header-background-color: ".concat(this.$store.getters["widget/headerBgColor"], " !important;\n\t\t\t\t\t--tawk-header-background-color-alpha: ").concat(this.$store.getters["widget/headerBgColor"], "50 !important;\n\t\t\t\t\t--tawk-header-text-color: ").concat(this.$store.getters["widget/headerTxtColor"], " !important;\n\t\t\t\t\t--tawk-header-override-padding-top: ").concat(o, " !important;\n\t\t\t\t\t--tawk-footer-override-padding-bottom: ").concat(n, " !important;\n\t\t\t\t}");
