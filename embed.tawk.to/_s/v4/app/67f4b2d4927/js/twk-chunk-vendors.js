    ...
    ["chunk-vendors"], {
        ...
        "13d2": function(t, e, n) {
            ...
            var r = n("e330"),
                ...
                b = t.exports = function(t, e, n) {
                    "Symbol(" === g(f(e), 0, 7) && (e = "[" + m(f(e), /^Symbol\(([^)]*)\).*$/, "$1") + "]"), n && n.getter && (e = "get " + e), n && n.setter && (e = "set " + e), (!a(t, "name") || l && t.name !== e) && (s ? d(t, "name", {
                        value: e,
                        configurable: !0
                    }) : t.name = e), y && n && a(n, "arity") && t.length !== n.arity && d(t, "length", {
                        value: n.arity
                    });
                    try {
                    ...
                    var r = h(t);
                    return a(r, "source") || (r.source = _(v, "string" == typeof e ? e : "")), t
                };
        ...
        2266: function(t, e, n) {
            ...
            t.exports = function(t, e, n) {
                var m, _, y, v, b, w, k, x = n && n.that,
                    ...
                    j = function(t) {
                        return S ? (o(t), O ? E(t[0], t[1], L) : E(t[0], t[1])) : O ? E(t, L) : E(t)
                    };
                if (T) m = t.iterator;
                else if (C) m = t;
                else {
                    if (!(_ = h(t))) throw new f(a(t) + " is not iterable");
                    if (s(_)) {
                        for (y = 0, v = l(t); v > y; y++)
                            if ((b = j(t[y])) && c(g, b)) return b;
                        return new d(!1)
                    }
                    m = u(t, _)
                }
        ...
        "23e7": function(t, e, n) {
            ...
            var r = n("da84"),
                ...
                c = n("94ca");
            t.exports = function(t, e) {
                var n, u, h, p, f, d = t.target,
                    g = t.global,
                    m = t.stat;
                if (n = g ? r : m ? r[d] || s(d, {}) : r[d] && r[d].prototype)
                    for (u in e) {
                        if (p = e[u], t.dontCallGetSet ? h = (f = i(n, u)) && f.value : h = n[u], !c(g ? u : d + (m ? "." : "#") + u, t.forced) && void 0 !== h) {
        ...
        "2cf4": function(t, e, n) {
            ...
            v && b || (v = function(t) {
                ...
                k.now(j(t))
            } : S && !_ ? (a = (o = new S).port2, o.port1.onmessage = R, i = c(a.postMessage, a)) : s.addEventListener && u(s.postMessage) && !s.importScripts && r && "file:" !== r.protocol && !p(A) ? (i = A, s.addEventListener("message", R, !1)) : i = E in g("script") ? function(t) {
            ...
            var r = n("da84"),
                ...
                _ = a("Promise", (function() {
                    ...
                    if (!p || p < 51 || !/native code/.test(t)) {
                        ...
                        if ((n.constructor = {})[d] = r, !(g = n.then((function() {})) instanceof r)) return !0
                    }
                    return !e && (c || u) && !m
                }));
            t.exports = {
        ...
        "499e": function(t, e, n) {
            ...
            function _(t) {
                ...
                if (f) {
                    var i = l++;
                    r = s || (s = m()), e = v.bind(null, r, i, !1), n = v.bind(null, r, i, !0)
                } else r = m(), e = b.bind(null, r), n = function() {
                    r.parentNode.removeChild(r)
                };
                return e(t),
                    function(r) {
            ...
            function b(t, e) {
                var n = e.css,
                    r = e.media,
                    i = e.sourceMap;
                if (r && t.setAttribute("media", r), h.ssrId && t.setAttribute(p, e.id), i && (n += "\n/*# sourceURL=" + i.sources[0] + " */", n += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(i)))) + " */"), t.styleSheet) t.styleSheet.cssText = n;
                else {
            ...
            (function(t) {
                ...
                var f = function(t, e) {
                    ...
                    m = function(e, n, r, i) {
                        ...
                        "undefined" == typeof window && void 0 !== t && void 0 !== t.process && t.process.versions && t.process.versions.node && (o["User-Agent"] = "i18next-http-backend (node/".concat(t.process.version, "; ").concat(t.process.platform, " ").concat(t.process.arch, ")")), r && (o["Content-Type"] = "application/json");
                        ...
                        try {
                            ...
                            if (!a || 0 === Object.keys(a).length || !t.message || t.message.indexOf("not implemented") < 0) return i(t);
                            try {
                    ...
                    _ = function(t, e, n, r) {
                        n && "object" === p(n) && (n = f("", n).slice(1)), t.queryStringParams && (e = f(e, t.queryStringParams));
                        try {
                            var a;
                            (a = i ? new i : new o("MSXML2.XMLHTTP.3.0")).open(n ? "POST" : "GET", e, 1), t.crossDomain || a.setRequestHeader("X-Requested-With", "XMLHttpRequest"), a.withCredentials = !!t.withCredentials, n && a.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), a.overrideMimeType && a.overrideMimeType("application/json");
                ...
                e.a = function(t, e, n, i) {
                    return "function" == typeof n && (i = n, n = void 0), i = i || function() {}, r && 0 !== e.indexOf("file:") ? m(t, e, n, i) : Object(a.a)() || "function" == typeof ActiveXObject ? _(t, e, n, i) : void i(new Error("No fetch and no xhr implementation found!"))
                }
            }).call(this, n("c8ba"))
        },
        5926: function(t, e, n) {
            ...
            (function(n) {
                ...
                (function(t) {
                    ! function(e) {
                        ...
                        T.polyfill = !0, n.fetch || (n.fetch = T, n.Headers = f, n.Request = b, n.Response = x), e.Headers = f, e.Request = b, e.Response = x, e.fetch = T
                    }({})
        ...
        "5e7e": function(t, e, n) {
            ...
            var r, i, o, a = n("23e7"),
                ...
                W = function(t, e) {
                    var n, r, i, o = e.value,
                        ...
                        h = t.domain;
                    try {
                        s ? (a || (2 === e.rejection && G(e), e.rejection = 1), !0 === s ? n = o : (h && h.enter(), n = s(o), h && (h.exit(), i = !0)), n === t.promise ? c(new N("Promise-chain cycle")) : (r = X(n)) ? u(r, n, l, c) : l(n)) : c(o)
                    } catch (t) {
                        h && !i && h.exit(), c(t)
                    }
                },
                ...
                Y = function(t, e, n) {
                    var r, i;
                    F ? ((r = M.createEvent("Event")).promise = e, r.reason = n, r.initEvent(t, !1, !0), c.dispatchEvent(r)) : r = {
                        promise: e,
                        reason: n
                ...
                K = function(t) {
                    u(b, c, (function() {
                        ...
                        if (J(t) && (e = x((function() {
                            ...
                            })), t.rejection = l || J(t) ? 2 : 1, e.error)) throw e.value
                    }))
                },
                J = function(t) {
            ...
            if (j && (B = (D = function(t) {
                    ...
                    var n = P(this),
                        r = H(v(this, D));
                    return n.parent = !0, r.ok = !m(t) || t, r.fail = m(e) && e, r.domain = l ? q.domain : void 0, 0 === n.state ? n.reactions.add(r) : w((function() {
                        W(r, n)
                    })), r.promise
                })), i = function() {
                    var t = new r,
        ...
        "5f34": function(t, e, n) {
            ...
            class i {
                ...
                init(t) {
                    let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                    this.prefix = e.prefix || "i18next:", this.logger = t || r, this.options = e, this.debug = e.debug
                }
                log() {
                ...
                clone(t) {
                    return (t = t || this.options).prefix = t.prefix || this.prefix, new i(this.logger, t)
                }
            }
            var o = new i;
            class a {
                ...
                emit(t) {
                    ...
                    if (this.observers["*"]) {
                        Array.from(this.observers["*"].entries()).forEach(e => {
                            let [r, i] = e;
                            for (let e = 0; e < i; e++) r.apply(r, [t, ...n])
                        })
                    }
                }
            }
            ...
            function h(t, e, n) {
                ...
                if (void 0 !== r || 1 === e.length) return void(r[i] = n);
                let o = e[e.length - 1],
                    a = e.slice(0, e.length - 1),
                    s = u(t, a, Object);
                for (; void 0 === s.obj && a.length;) o = `${a[a.length-1]}.${o}`, a = a.slice(0, a.length - 1), s = u(t, a, Object), s && s.obj && void 0 !== s.obj[`${s.k}.${o}`] && (s.obj = void 0);
                s.obj[`${s.k}.${o}`] = n
            }
            ...
            function v(t, e) {
                ...
                for (let t = 0; t < r.length;) {
                    ...
                    for (let a = t; a < r.length; ++a)
                        if (a !== t && (o += n), o += r[a], e = i[o], void 0 !== e) {
                            if (["string", "number", "boolean"].indexOf(typeof e) > -1 && a < r.length - 1) continue;
                            t += a - t + 1;
                            break
                        }
                    i = e
            ...
            class w extends a {
                ...
                getResource(t, e, n) {
                    ...
                    let a;
                    t.indexOf(".") > -1 ? a = t.split(".") : (a = [t, e], n && (Array.isArray(n) ? a.push(...n) : "string" == typeof n && i ? a.push(...n.split(i)) : a.push(n)));
                    const s = p(this.data, a);
                    return !s && !e && !n && t.indexOf(".") > -1 && (t = a[0], e = a[1], n = a.slice(2).join(".")), s || !o || "string" != typeof n ? s : v(this.data && this.data[t] && this.data[t][e], n, i)
                }
                addResource(t, e, n, r) {
                    ...
                    let a = [t, e];
                    n && (a = a.concat(o ? n.split(o) : n)), t.indexOf(".") > -1 && (a = t.split("."), r = e, e = a[1]), this.addNamespaces(e), h(this.data, a, r), i.silent || this.emit("added", t, e, n, r)
                }
                addResources(t, e, n) {
                    let r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {
                        silent: !1
                    };
                    for (const r in n)("string" == typeof n[r] || Array.isArray(n[r])) && this.addResource(t, e, r, n[r], {
                        silent: !0
                    });
                ...
                addResourceBundle(t, e, n, r, i) {
                    let o = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : {
                        ...
                        a = [t, e];
                    t.indexOf(".") > -1 && (a = t.split("."), r = n, n = e, e = a[1]), this.addNamespaces(e);
                    let s = p(this.data, a) || {};
                    o.skipCopy || (n = JSON.parse(JSON.stringify(n))), r ? function t(e, n, r) {
                        for (const i in n) "__proto__" !== i && "constructor" !== i && (i in e ? "string" == typeof e[i] || e[i] instanceof String || "string" == typeof n[i] || n[i] instanceof String ? r && (e[i] = n[i]) : t(e[i], n[i], r) : e[i] = n[i]);
                        return e
                    }(s, n, i) : s = { ...s,
                        ...n
                    }, h(this.data, a, s), o.silent || this.emit("added", t, e, n)
                }
            ...
            class S extends a {
                constructor(t) {
                    ...
                    super(),
                        ...
                        }(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], t, this), this.options = e, void 0 === this.options.keySeparator && (this.options.keySeparator = "."), this.logger = o.create("translator")
                }
                changeLanguage(t) {
                    t && (this.language = t)
                }
                ...
                translate(t, e, n) {
                    ...
                    if (m && h && ("string" != typeof h && "boolean" != typeof h && "number" != typeof h) && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(d) < 0 && ("string" != typeof g || !Array.isArray(h))) {
                        if (!e.returnObjects && !this.options.returnObjects) {
                            ...
                            return r ? (u.res = t, u.usedParams = this.getUsedParamsDetails(e), u) : t
                        }
                        if (i) {
                    ...
                    } else if (m && "string" == typeof g && Array.isArray(h)) h = h.join(g), h && (h = this.extendTranslation(h, t, e, n));
                    else {
                        let r = !1,
                            a = !1;
                        ...
                        !this.isValidLookup(h) && p && (r = !0, h = m), this.isValidLookup(h) || (a = !0, h = o);
                        ...
                        if (a || r || y) {
                            if (this.logger.log(y ? "updateKey" : "missingKey", l, s, o, y ? m : h), i) {
                                const t = this.resolve(o, { ...e,
                                    keySeparator: !1
                                });
                            ...
                            const r = (t, n, r) => {
                                const i = p && r !== h ? r : _;
                                this.options.missingKeyHandler ? this.options.missingKeyHandler(t, s, n, i, y, e) : this.backendConnector && this.backendConnector.saveMissing && this.backendConnector.saveMissing(t, s, n, i, y, e), this.emit("missingKey", t, s, n, h)
                            };
                            this.options.saveMissing && (this.options.saveMissingPlurals && c ? t.forEach(t => {
                                const n = this.pluralResolver.getSuffixes(t, e);
                                g && e[`defaultValue${this.options.pluralSeparator}zero`] && n.indexOf(this.options.pluralSeparator + "zero") < 0 && n.push(this.options.pluralSeparator + "zero"), n.forEach(n => {
                                    r([t], o + n, e["defaultValue" + n] || m)
                                })
                            }) : r(t, o, m))
                        }
                        h = this.extendTranslation(h, t, e, u, n), a && h === o && this.options.appendNamespaceToMissingKey && (h = `${s}:${o}`), (a || r) && this.options.parseMissingKeyHandler && (h = "v1" !== this.options.compatibilityAPI ? this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${s}:${o}` : o, r ? h : void 0) : this.options.parseMissingKeyHandler(h))
                    }
                    return r ? (u.res = h, u.usedParams = this.getUsedParamsDetails(e), u) : h
                }
                extendTranslation(t, e, n, r, i) {
                    ...
                    if (this.i18nFormat && this.i18nFormat.parse) t = this.i18nFormat.parse(t, { ...this.options.interpolation.defaultVariables,
                        ...
                        if (this.options.interpolation.defaultVariables && (l = { ...this.options.interpolation.defaultVariables,
                                ...l
                            }), t = this.interpolator.interpolate(t, l, n.lng || this.language, n), a) {
                            const e = t.match(this.interpolator.nestingRegexp);
                            ...
                            return i && i[0] === r[0] && !n.context ? (o.logger.warn(`It seems you are nesting recursively key: ${r[0]} in key: ${e[0]}`), null) : o.translate(...r, e)
                        ...
                        c.forEach(t => {
                            this.isValidLookup(e) || (o = t, !x[`${f[0]}-${t}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(o) && (x[`${f[0]}-${t}`] = !0, this.logger.warn(`key "${n}" for languages "${f.join(", ")}" won't get resolved as namespace "${o}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), f.forEach(n => {
                                ...
                                if (this.i18nFormat && this.i18nFormat.addLookupKeys) this.i18nFormat.addLookupKeys(o, l, n, t, a);
                                    ...
                                    if (u && (o.push(l + t), a.ordinal && 0 === t.indexOf(r) && o.push(l + t.replace(r, this.options.pluralSeparator)), h && o.push(l + e)), p) {
                                        const n = `${l}${this.options.contextSeparator}${a.context}`;
                                        o.push(n), u && (o.push(n + t), a.ordinal && 0 === t.indexOf(r) && o.push(n + t.replace(r, this.options.pluralSeparator)), h && o.push(n + e))
                                    }
                                }
                                let s;
                                for (; s = o.pop();) this.isValidLookup(e) || (r = s, e = this.getResource(n, t, s, a))
                            }))
                        })
                    }), {
                        res: e,
                ...
                getUsedParamsDetails() {
                    ...
                    let r = n ? t.replace : t;
                    if (n && void 0 !== t.count && (r.count = t.count), this.options.interpolation.defaultVariables && (r = { ...this.options.interpolation.defaultVariables,
                            ...r
                        }), !n) {
                        r = { ...r
                        };
            ...
            class C {
                ...
                formatLanguageCode(t) {
                    if ("string" == typeof t && t.indexOf("-") > -1) {
                        ...
                        let n = t.split("-");
                        return this.options.lowerCaseLng ? n = n.map(t => t.toLowerCase()) : 2 === n.length ? (n[0] = n[0].toLowerCase(), n[1] = n[1].toUpperCase(), e.indexOf(n[1].toLowerCase()) > -1 && (n[1] = T(n[1].toLowerCase()))) : 3 === n.length && (n[0] = n[0].toLowerCase(), 2 === n[1].length && (n[1] = n[1].toUpperCase()), "sgn" !== n[0] && 2 === n[2].length && (n[2] = n[2].toUpperCase()), e.indexOf(n[1].toLowerCase()) > -1 && (n[1] = T(n[1].toLowerCase())), e.indexOf(n[2].toLowerCase()) > -1 && (n[2] = T(n[2].toLowerCase()))), n.join("-")
                    }
                ...
                getFallbackCodes(t, e) {
                    if (!t) return [];
                    if ("function" == typeof t && (t = t(e)), "string" == typeof t && (t = [t]), Array.isArray(t)) return t;
            ...
            function P(t, e, n) {
                let r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : ".",
                    ...
                    o = f(t, e, n);
                return !o && i && "string" == typeof n && (o = v(t, n, r), void 0 === o && (o = v(e, n, r))), o
            }
            class I {
                constructor() {
                    let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                ...
                init() {
                    ...
                    this.escape = void 0 !== e ? e : m, this.escapeValue = void 0 === n || n, this.useRawValueToEscape = void 0 !== r && r, this.prefix = i ? d(i) : o || "{{", this.suffix = a ? d(a) : s || "}}", this.formatSeparator = l || ",", this.unescapePrefix = c ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : c || "", this.nestingPrefix = h ? d(h) : p || d("$t("), this.nestingSuffix = f ? d(f) : g || d(")"), this.nestingOptionsSeparator = _ || ",", this.maxReplaces = y || 1e3, this.alwaysFormat = void 0 !== v && v, this.resetRegExp()
                }
                reset() {
                ...
                interpolate(t, e, n, r) {
                    ...
                    const u = t => {
                        ...
                        return this.format(P(e, s, o, this.options.keySeparator, this.options.ignoreJSONStructure), a, n, { ...r,
                            ...e,
                            interpolationkey: o
                        })
                    };
                    ...
                    return [{
                        ...
                        for (a = 0; i = e.regex.exec(t);) {
                            ...
                            if (o = u(n), void 0 === o)
                                ...
                                this.logger.warn(`missed to pass in variable ${n} for interpolating ${t}`), o = ""
                            } else "string" == typeof o || this.useRawValueToEscape || (o = l(o));
                            const s = e.safeValue(o);
                            if (t = t.replace(i[0], s), p ? (e.regex.lastIndex += o.length, e.regex.lastIndex -= i[0].length) : e.regex.lastIndex = 0, a++, a >= this.maxReplaces) break
                        }
                    }), t
                }
                nest(t, e) {
                    ...
                    function a(t, e) {
                        ...
                        let o = "{" + r[1];
                        t = r[0], o = this.interpolate(o, i);
                        const a = o.match(/'/g),
                            s = o.match(/"/g);
                        (a && a.length % 2 == 0 && !s || s.length % 2 != 0) && (o = o.replace(/'/g, '"'));
                        try {
                            i = JSON.parse(o), e && (i = { ...e,
                                ...i
                            })
                        } catch (e) {
                            return this.logger.warn("failed parsing options string in nesting for key " + t, e), `${t}${n}${o}`
                        }
                        return i.defaultValue && i.defaultValue.indexOf(this.prefix) > -1 && delete i.defaultValue, t
                    }
                    for (; n = this.nestingRegexp.exec(t);) {
                        ...
                        if (r = e(a.call(this, n[1].trim(), i), i), r && n[0] === t && "string" != typeof r) return r;
                        "string" != typeof r && (r = l(r)), r || (this.logger.warn(`missed to resolve ${n[1]} for nesting ${t}`), r = ""), c && (r = s.reduce((t, e) => this.format(t, e, o.lng, { ...o,
                    ...
                    return e.split(this.formatSeparator).reduce((t, e) => {
                        const {
                            ...
                            if (t.indexOf("(") > -1) {
                                ...
                                if ("currency" === e && i.indexOf(":") < 0) n.currency || (n.currency = i.trim());
                                else if ("relativetime" === e && i.indexOf(":") < 0) n.range || (n.range = i.trim());
                                else {
                                    i.split(";").forEach(t => {
                                        if (t) {
                                            const [e, ...r] = t.split(":"), i = r.join(":").trim().replace(/^'+|'+$/g, ""), o = e.trim();
            ...
            class B extends a {
                ...
                queueLoad(t, e, n, r) {
                    ...
                    return t.forEach(t => {
                        ...
                        e.forEach(e => {
                            const a = `${t}|${e}`;
                            !n.reload && this.store.hasResourceBundle(t, e) ? this.state[a] = 2 : this.state[a] < 0 || (1 === this.state[a] ? void 0 === o[a] && (o[a] = !0) : (this.state[a] = 1, r = !1, void 0 === o[a] && (o[a] = !0), void 0 === i[a] && (i[a] = !0), void 0 === s[e] && (s[e] = !0)))
                        }), r || (a[t] = !0)
                ...
                loaded(t, e, n) {
                    const r = t.split("|"),
                        i = r[0],
                        o = r[1];
                    e && this.emit("failedLoading", i, o, e), n && this.store.addResourceBundle(i, o, n, void 0, void 0, {
                        skipCopy: !0
                    }), this.state[t] = e ? -1 : 2;
                    const a = {};
                ...
                loadOne(t) {
                    ...
                    this.read(r, i, "read", void 0, void 0, (n, o) => {
                        n && this.logger.warn(`${e}loading namespace ${i} for language ${r} failed`, n), !n && o && this.logger.log(`${e}loaded namespace ${i} for language ${r}`, o), this.loaded(t, n, o)
                    })
                }
                saveMissing(t, e, n, r, i) {
                    ...
                    if (this.services.utils && this.services.utils.hasLoadedNamespace && !this.services.utils.hasLoadedNamespace(e)) this.logger.warn(`did not save key "${n}" as the namespace "${e}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!");
                        ...
                        if (this.backend && this.backend.create) {
                            ...
                            if (l.length < 6) try {
                                let i;
                                i = 5 === l.length ? l(t, e, n, r, s) : l(t, e, n, r), i && "function" == typeof i.then ? i.then(t => a(null, t)).catch(a) : a(null, i)
                            } catch (t) {
                                a(t)
                            } else l(t, e, n, r, a, s)
                        }
            ...
            class H extends a {
                constructor() {
                    ...
                    if (super(), this.options = M(t), this.services = {}, this.logger = o, this.modules = {
                            external: []
                        }, function(t) {
                ...
                init() {
                    ...
                    this.isInitializing = !0, "function" == typeof e && (n = e, e = {}), !e.defaultNS && !1 !== e.defaultNS && e.ns && ("string" == typeof e.ns ? e.defaultNS = e.ns : e.ns.indexOf("translation") < 0 && (e.defaultNS = e.ns[0]));
                    const r = N();
                    ...
                    if (this.options = { ...r,
                        ...
                        let e;
                        this.modules.logger ? o.init(i(this.modules.logger), this.options) : o.init(null, this.options), this.modules.formatter ? e = this.modules.formatter : "undefined" != typeof Intl && (e = D);
                        const n = new C(this.options);
                        this.store = new w(this.options.resources, this.options);
                        const a = this.services;
                        a.logger = o, a.resourceStore = this.store, a.languageUtils = n, a.pluralResolver = new A(n, {
                            prepend: this.options.pluralSeparator,
                            compatibilityJSON: this.options.compatibilityJSON,
                            simplifyPluralSuffix: this.options.simplifyPluralSuffix
                        }), !e || this.options.interpolation.format && this.options.interpolation.format !== r.interpolation.format || (a.formatter = i(e), a.formatter.init(a, this.options), this.options.interpolation.format = a.formatter.format.bind(a.formatter)), a.interpolator = new I(this.options), a.utils = {
                            hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
                        }, a.backendConnector = new B(i(this.modules.backend), a.resourceStore, a, this.options), a.backendConnector.on("*", (function(e) {
                ...
                loadResources(t) {
                    ...
                    if ("function" == typeof t && (e = t), !this.options.resources || this.options.partialBundledLanguages) {
                        if (n && "cimode" === n.toLowerCase() && (!this.options.preload || 0 === this.options.preload.length)) return e();
                        const t = [],
                            r = e => {
                                if (!e) return;
                                if ("cimode" === e) return;
                        ...
                        this.options.preload && this.options.preload.forEach(t => r(t)), this.services.backendConnector.load(t, this.options.ns, t => {
                ...
                use(t) {
                    ...
                    return "backend" === t.type && (this.modules.backend = t), ("logger" === t.type || t.log && t.warn && t.error) && (this.modules.logger = t), "languageDetector" === t.type && (this.modules.languageDetector = t), "i18nFormat" === t.type && (this.modules.i18nFormat = t), "postProcessor" === t.type && k.addPostProcessor(t), "formatter" === t.type && (this.modules.formatter = t), "3rdParty" === t.type && this.modules.external.push(t), this
                }
                ...
                getFixedT(t, e, n) {
                    ...
                    const i = function(t, e) {
                        ...
                        let u;
                        return u = o.keyPrefix && Array.isArray(t) ? t.map(t => `${o.keyPrefix}${c}${t}`) : o.keyPrefix ? `${o.keyPrefix}${c}${t}` : t, r.t(u, o)
                    };
                ...
                loadLanguages(t, e) {
                    ...
                    return i.length ? (this.options.preload = r.concat(i), this.loadResources(t => {
                        n.resolve(), e && e(t)
                    }), n) : (e && e(), Promise.resolve())
                }
                dir(t) {
                ...
                cloneInstance() {
                    ...
                    }, n && (i.store = new w(this.store.data, r), i.services.resourceStore = i.store), i.translator = new S(i.services, r), i.translator.on("*", (function(t) {
                        for (var e = arguments.length, n = new Array(e > 1 ? e - 1 : 0), r = 1; r < e; r++) n[r - 1] = arguments[r];
                        i.emit(t, ...n)
                    })), i.init(r, e), i.translator.options = r, i.translator.backendConnector.services.utils = {
                        hasLoadedNamespace: i.hasLoadedNamespace.bind(i)
                    }, i
                }
                toJSON() {
        ...
        "60da": function(t, e, n) {
            ...
            t.exports = !p || a((function() {
                ...
                for (var n = u(t), i = arguments.length, a = 1, p = l.f, f = c.f; i > a;)
                    for (var g, m = h(arguments[a++]), _ = p ? d(s(m), p(m)) : s(m), y = _.length, v = 0; y > v;) g = _[v++], r && !o(f, m, g) || (n[g] = m[g]);
                return n
            } : p
        },
        6374: function(t, e, n) {
        ...
        "68ee": function(t, e, n) {
            ...
            g.sham = !0, t.exports = !u || i((function() {
                var t;
        ...
        "69f3": function(t, e, n) {
            ...
            t.exports = {
                ...
                getterFor: function(t) {
                    return function(e) {
                        var n;
                        if (!l(e) || (n = i(e)).type !== t) throw new g("Incompatible receiver, " + t + " required");
                        return n
                    }
                }
            }
        ...
        "6f53": function(t, e, n) {
            ...
            var r = n("83ab"),
                ...
                p = function(t) {
                    return function(e) {
                        for (var n, i = l(e), o = s(i), p = h && null === a(i), f = o.length, d = 0, g = []; f > d;) n = o[d++], r && !(p ? n in i : c(i, n)) || u(g, t ? [n, i[n]] : i[n]);
                        return g
                    }
                };
            t.exports = {
                                    ...
                                    return e(this, void 0, void 0, (function() {
                                        ...
                                        return n(this, (function(n) {
                                            ...
                                            if (a = e.cb, s = e._options, l = t[0], c = {
                                                    ...
                                                    resolve: i,
                                                    reject: o
                                                }, p = r._resolveWithCB(a, i, o), f = r._heldLockSet(), d = f.find((function(t) {
                                                ...
                                                if (!0 === s.ifAvailable) return d && (d.mode !== u.SHARED || c.mode !== u.SHARED) || g.length ? [2, p(null)] : [2, r._handleNewHeldLock(c, p)];
                                                if (void 0 !== s.signal && !r._handleSignalExisted(s, o, c)) return [2]
                                            }
                                            return r._handleHeldLockAndRequest(d, c, p, g, f), [2]
                                        }))
                                    }))
                                }))]
                            }))
        ...
        "7c73": function(t, e, n) {
            ...
            s[f] = !0, t.exports = Object.create || function(t, e) {
                var n;
                return null !== t ? (d[h] = i(t), n = new d, d[h] = null, n[f] = t) : n = _(), void 0 === e ? n : o.f(n, e)
            }
        },
        "7db0": function(t, e, n) {
            "use strict";
            ...
            var r = function() {
                ...
                m = function() {
                    ...
                    return t.prototype.parseMarkdown = function(t) {
                        return t = (t = this.standardizeLineEndings(t)).replace(/\$/g, "DOLLAR=SIGN=PLACEHOLDER"), t = (t = this.fixCodeBlocks(this.replaceMarkdown("\n" + t + "\n")).trim()).replace(/DOLLAR=SIGN=PLACEHOLDER/g, "$")
                        ...
                        return t.replace(a, (function(t, n, i, o) {
                            ...
                            return o && (s.alt = o), "object" == typeof e.options && e.options.a && e.options.a.length > 0 && e.options.a.forEach((function(e) {
                                void 0 === e.rule && e.attributes && (s = r(r({}, s), e.attributes)), e.rule && e.rule.test(t) && (s = r(r({}, s), e.attributes))
                        ...
                        return t.replace(l, (function(t, e) {
                            var n, r, i = "",
                                o = "",
                                a = (null === (n = t.match(/^\*+/)) || void 0 === n ? void 0 : n[0].length) || 0,
                                s = (null === (r = t.match(/\*+$/)) || void 0 === r ? void 0 : r[0].length) || 0;
                            return a !== s && (a >= 2 || s >= 2) && (a > 2 && s > 2 ? (i = "*".repeat(a - 2), o = "*".repeat(s - 2)) : (i = "*".repeat(a - 1), o = "*".repeat(s - 1))), i + "<strong>" + e + "</strong>" + o
                        }))
                        ...
                        return t.replace(c, (function(t, e) {
                            ...
                            return a !== s && (a >= 2 || s >= 2) && (a > 2 && s > 2 ? (i = "_".repeat(a - 2), o = "_".repeat(s - 2)) : (i = "_".repeat(a - 1), o = "_".repeat(s - 1))), i + "<i>" + e + "</i>" + o
                        }))
                        ...
                        return t.replace(u, (function(t, e) {
                            var n, r, i = "",
                                ...
                                a = (null === (n = t.match(/^~+/)) || void 0 === n ? void 0 : n[0].length) || 0,
                                s = (null === (r = t.match(/~+$/)) || void 0 === r ? void 0 : r[0].length) || 0;
                            return a !== s && (a >= 2 || s >= 2) && (a > 2 && s > 2 ? (i = "~".repeat(a - 2), o = "~".repeat(s - 2)) : (i = "~".repeat(a - 1), o = "~".repeat(s - 1))), i + "<del>" + e + "</del>" + o
                        }))
                        ...
                        return t.replace(p, (function(t) {
                            ...
                            for (t.trim().split("\n").forEach((function(t) {
                                    var r = t.match(/^(\s*)(-|\+)(?!-|\+)(.*)/);
                                    if (r) {
                                        for (var i = r[1].length, o = r[3].trim(); n > i;) e.push("</ul>"), n--;
                                        n < i ? (e.push("<ul><li>".concat(o, "</li>")), n++) : e.push("<li>".concat(o, "</li>"))
                                    }
                                })); n > 0;) e.push("</ul>"), n--;
                        ...
                        return t.replace(f, (function(t) {
                            ...
                            for (t.trim().split("\n").forEach((function(t) {
                                    var o = t.match(/(\d+\.)\s(.*)/);
                                    if (o) {
                                        for (var a = e.countLevels(t) - 1; r > a;) n.push("</ol>"), i.pop(), r--;
                        ...
                        return n = (n = n.replace(/```([\s\S]*?)```/g, (function(t) {
                            return i.push(t), "CODEBLOCK=PLACEHOLDER=".concat((i.length - 1).toString())
                        }))).replace(/`([^`]+)`/g, (function(t) {
                            return r.push(t), "INLINECODE=PLACEHOLDER=".concat((r.length - 1).toString())
                        })), n = this.replaceBold(n), n = this.replaceItalic(n), n = this.replaceLinksWithTargetParent(n), n = this.replaceLinks(n), n = this.replaceceStrikethrough(n), n = this.replaceBlockquotes(n), n = this.replaceUnorderedLists(n), n = (n = (n = this.replaceOrderedLists(n)).replace(/INLINECODE=PLACEHOLDER=(\d+)/g, (function(t, n) {
        ...
        ae93: function(t, e, n) {
            ...
            [].keys && ("next" in (o = [].keys()) ? (i = u(u(o))) !== Object.prototype && (r = i) : g = !0), !l(r) || a((function() {
                var t = {};
                return r[d].call(t) !== t
            })) ? r = {} : f && (r = c(r)), s(r[d]) || h(r, d, (function() {
                return this
            })), t.exports = {
                IteratorPrototype: r,
        ...
        b575: function(t, e, n) {
            ...
            if (!w) {
                var k = new p,
                    x = function() {
                        var t, e;
                        for (m && (t = v.domain) && t.exit(); e = k.get();) try {
                            e()
                        } catch (t) {
                            throw k.head && r(), t
                        }
                ...
                f || m || g || !_ || !y ? !d && b && b.resolve ? ((a = b.resolve(void 0)).constructor = b, s = u(a.then, a), r = function() {
                    s(x)
                }) : m ? r = function() {
                    v.nextTick(x)
                } : (h = u(h, l), r = function() {
                    h(x)
                }) : (i = !0, o = y.createTextNode(""), new _(x).observe(o, {
                    characterData: !0
                }), r = function() {
                    o.data = i = !i
                }), w = function(t) {
        ...
        c6d2: function(t, e, n) {
            ...
            t.exports = function(t, e, n, a, d, m, C) {
                ...
                var O, E, L, j = function(t) {
                    ...
                    A = !1,
                    P = t.prototype,
                    I = P[w] || P["@@iterator"] || d && P[d],
                    $ = !b && I || j(d),
                    D = "Array" === e && P.entries || I;
                if (D && ((O = c(D.call(new t))) !== Object.prototype && O.next && (o || c(O) === v || (u ? u(O, v) : s(O[w]) || f(O, w, T)), h(O, R, !0, !0), o && (g[R] = T))), _ && d === x && I && I.name !== x && (!o && y ? p(P, "name", x) : (A = !0, $ = function() {
                        return i(I, this)
                    })), d)
                    if (E = {
                            values: j(x),
                        ...
                        for (L in E)(b || A || !(L in P)) && f(P, L, E[L]);
                    else r({
                        target: e,
                        proto: !0,
                        forced: b || A
                        ...
                        20: [function(t, e, n) {
                            (function(e) {
                                ...
                                function y(t, e, r) {
                                    ...
                                    return i[0] = p[t.type], r(new g([i.buffer, t.data]))
                                }
                                ...
                                n.encodePacket = function(t, n, r, i) {
                                    ...
                                    if (e.ArrayBuffer && o instanceof ArrayBuffer) return _(t, n, i);
                                    if (g && o instanceof e.Blob) return y(t, n, i);
                                    if (o && o.base64) return m(t, i);
                                    var a = p[t.type];
                                    ...
                                    for (var o, a, s = "", l = 0, c = t.length; l < c; l++) {
                                        ...
                                        if (":" != u) s += u;
                                            ...
                                            if (s != (a = t.substr(l + 1, o)).length) return r(d, 0, 1);
                                            if (a.length) {
                                                if (i = n.decodePacket(a, e, !0), d.type == i.type && d.data == i.data) return r(d, 0, 1);
                                    ...
                                    for (var i = t, a = [], s = !1; i.byteLength > 0;) {
                                        ...
                                        if (c) try {
                                            ...
                                            for (p = "", h = 0; h < f.length; h++) p += String.fromCharCode(f[h])
                                        }
                                        a.push(p), i = o(i, u)
                                    }
                                    var g = a.length;
                            ...
                            (function(t) {
                                ! function(r) {
                                    ...
                                    function d(t) {
                                        ...
                                        var e = "";
                                        return 0 == (4294965248 & t) ? e = u(t >> 6 & 31 | 192) : 0 == (4294901760 & t) ? (p(t), e = u(t >> 12 & 15 | 224), e += f(t, 6)) : 0 == (4292870144 & t) && (e = u(t >> 18 & 7 | 240), e += f(t, 12), e += f(t, 6)), e += u(63 & t | 128)
                                    }
                                    ...
                                    function m() {
                                        ...
                                        if (224 == (240 & t)) {
                                            if ((e = (15 & t) << 12 | (n = g()) << 6 | g()) >= 2048) return p(e), e;
                                            throw Error("Invalid continuation byte")
                                        }
                                    ...
                                    var _ = {
                                        version: "2.0.0",
                                        encode: function(t) {
                                            for (var e = h(t), n = e.length, r = -1, i = ""; ++r < n;) i += d(e[r]);
                                            return i
                                        },
                                        decode: function(t) {
                                    ...
                                    if (i && !i.nodeType)
                                        if (o) o.exports = _;
                                            ...
                                            for (var v in _) y.call(_, v) && (i[v] = _[v])
                                        }
                                    else r.utf8 = _
                                }(this)
                            }).call(this, "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
                ...
                f = function(t, e, n) {
                    ...
                    value: function(t) {
                        var e = this,
                            ...
                            r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
                        if (this.services = t, this.options = s(s(s({}, p()), this.options || {}), n), this.allOptions = r, this.services && this.options.reloadInterval) {
                    ...
                    value: function(t, e, n, i, o) {
                        ...
                        "function" == typeof this.options.loadPath && (s = this.options.loadPath(t, n)), (s = Object(r.b)(s)).then((function(r) {
                            if (!r) return o(null, {});
                    ...
                    value: function(t, e, n, r) {
                        ...
                        this.options.request(this.options, t, s, (function(o, a) {
                            ...
                            if (!a && o && o.message && o.message.indexOf("Failed to fetch") > -1) return e("failed loading " + t + ": " + o.message, !0);
                            if (o) return e(o, !1);
                            var s, l;
                            try {
                        ...
                        if (this.options.addPath) {
                            ...
                            t.forEach((function(n) {
                                ...
                                o.options.request(o.options, u, a, (function(e, n) {
                                    s += 1, l.push(e), c.push(n), s === t.length && "function" == typeof i && i(l, c)
                                }))
                            }))
                        }
                    }
                    ...
                    value: function() {
                        ...
                        if (!o || "cimode" !== o.toLowerCase()) {
                            ...
                            s(o), this.allOptions.preload && this.allOptions.preload.forEach((function(t) {
                                return s(t)
        ...
        e260: function(t, e, n) {
            ...
            if (i("keys"), i("values"), i("entries"), !u && h && "values" !== g.name) try {
                s(g, "name", {
                    value: "values"
                })
            } catch (t) {}
        ...
        f0b0: function(t, e, n) {
            "undefined" != typeof self && self, t.exports = function(t) {
                ...
                fb15: function(t, e, n) {
                    ...
                    function v(t, e) {
                        return m(t), 0 === ((e = _(e, y)).ignore_whitespace ? t.trim().length : t.length)
                    }
                    ...
                    function w(t, e) {
                        var n, r;
                        m(t), "object" === b(e) ? (n = e.min || 0, r = e.max) : (n = arguments[1], r = arguments[2]);
                    ...
                    function E(t) {
                        ...
                        return m(t), (e = String(e)) ? "4" === e ? T.test(t) : "6" === e && O.test(t) : E(t, 4) || E(t, 6)
                    }
                    var L = {
                    ...
                    function D(t, e) {
                        if (m(t), (e = _(e, L)).require_display_name || e.allow_display_name) {
                            var n = t.match(j);
                            if (n) {
                                var r = n[1];
                        ...
                        if (! function(t, e) {
                                m(t), (e = _(e, k)).allow_trailing_dot && "." === t[t.length - 1] && (t = t.substring(0, t.length - 1)), !0 === e.allow_wildcard && 0 === t.indexOf("*.") && (t = t.substring(2));
                                var n = t.split("."),
                                    r = n[n.length - 1];
                                if (e.require_tld) {
                            ...
                            if (!E(o)) {
                                ...
                                var h = o.slice(1, -1);
                                if (0 === h.length || !E(h)) return !1
                            }
                        }
                        if ('"' === s[0]) return s = s.slice(1, s.length - 1), e.allow_utf8_local_part ? $.test(s) : P.test(s);
                        for (var p = e.allow_utf8_local_part ? I : R, f = s.split("."), d = 0; d < f.length; d++)
                            if (!p.test(f[d])) return !1;
                        ...
                        V = {
                            ...
                            methods: {
                                ...
                                beautifyFilename: function(t, e) {
                                    ...
                                    return r.length > 7 && (i = r.substring(r.length - 3) + i, r = r.substring(0, r.length - 3)), '<span class="tawk-flex-1 tawk-text-truncate">'.concat(r, '</span><span class="tawk-flex-none">').concat(i, '</span><span class="tawk-flex-none">&nbsp;(').concat(e, ")</span>")
                                },
                        ...
                        Z = {
                            ...
                            methods: {
                                customStyle: function(t, e) {
                                    e > 16 && (this.inputCustomStyle.height = N.convertPixelToRem(e / 1.3 + t) + "rem !important", this.inputCustomStyle.paddingTop = N.convertPixelToRem(e / 1.3) + "rem !important", this.labelCustomSize = !0)
                                }
                            }
                        },
                        tt = {
                            ...
                            methods: {
                                ...
                                handleIsEmpty: function() {
                                    return N.isEmpty(this.$refs.input.value) ? (this.$emit("update:error", !0), this.$emit("update:invalidType", "required"), !0) : (this.$emit("update:error", !1), this.$emit("update:invalidType", ""), !1)
                                },
                                handleValidation: function() {
                                    "email" !== this.validation && "phone" !== this.validation || (this.$refs.input.value = this.$refs.input.value.trim()), N.isValid({
                    ...
                    function at(t, e) {
                        if (!ot) throw new Error("No element matching method supported");
                        return ot.call(t, e)
                    }
                    ...
                    function bt(t, e, n, r, i) {
                        ...
                        if (void 0 === r && (r = !0), void 0 === i && (i = !1), "top" === e) o = ["contentHeight", "containerHeight", "scrollTop", "y", "up", "down"];
                            ...
                            var h = t.element;
                            t.reach[l] = null, h[s] < 1 && (t.reach[l] = "start"), h[s] > t[o] - t[a] - 1 && (t.reach[l] = "end"), e && (h.dispatchEvent(vt("ps-scroll-" + l)), e < 0 ? h.dispatchEvent(vt("ps-scroll-" + c)) : e > 0 && h.dispatchEvent(vt("ps-scroll-" + u)), r && function(t, e) {
                                dt(t, e), gt(t, e)
                            }(t, l)), t.reach[l] && (e || i) && h.dispatchEvent(vt("ps-" + l + "-reach-" + t.reach[l]))
                        }(t, n, o, r, i)
                    }
                    ...
                    yt.prototype.eventElement = function(t) {
                        ...
                        return e || (e = new mt(t), this.eventElements.push(e)), e
                    ...
                    function xt(t) {
                        ...
                        t.containerWidth = Math.round(r.width), t.containerHeight = Math.round(r.height), t.contentWidth = e.scrollWidth, t.contentHeight = e.scrollHeight, e.contains(t.scrollbarXRail) || (lt(e, ht.rail("x")).forEach((function(t) {
                                return st(t)
                            })), e.appendChild(t.scrollbarXRail)), e.contains(t.scrollbarYRail) || (lt(e, ht.rail("y")).forEach((function(t) {
                                return st(t)
                            })), e.appendChild(t.scrollbarYRail)), !t.settings.suppressScrollX && t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth ? (t.scrollbarXActive = !0, t.railXWidth = t.containerWidth - t.railXMarginWidth, t.railXRatio = t.containerWidth / t.railXWidth, t.scrollbarXWidth = St(t, wt(t.railXWidth * t.containerWidth / t.contentWidth)), t.scrollbarXLeft = wt((t.negativeScrollAdjustment + e.scrollLeft) * (t.railXWidth - t.scrollbarXWidth) / (t.contentWidth - t.containerWidth))) : t.scrollbarXActive = !1, !t.settings.suppressScrollY && t.containerHeight + t.settings.scrollYMarginOffset < t.contentHeight ? (t.scrollbarYActive = !0, t.railYHeight = t.containerHeight - t.railYMarginHeight, t.railYRatio = t.containerHeight / t.railYHeight, t.scrollbarYHeight = St(t, wt(t.railYHeight * t.containerHeight / t.contentHeight)), t.scrollbarYTop = wt(n * (t.railYHeight - t.scrollbarYHeight) / (t.contentHeight - t.containerHeight))) : t.scrollbarYActive = !1, t.scrollbarXLeft >= t.railXWidth - t.scrollbarXWidth && (t.scrollbarXLeft = t.railXWidth - t.scrollbarXWidth), t.scrollbarYTop >= t.railYHeight - t.scrollbarYHeight && (t.scrollbarYTop = t.railYHeight - t.scrollbarYHeight),
                            function(t, e) {
                                var n = {
                                        width: e.railXWidth
                                    },
                                    r = Math.floor(t.scrollTop);
                                e.isRtl ? n.left = e.negativeScrollAdjustment + t.scrollLeft + e.containerWidth - e.contentWidth : n.left = t.scrollLeft, e.isScrollbarXUsingBottom ? n.bottom = e.scrollbarXBottom - r : n.top = e.scrollbarXTop + r, rt(e.scrollbarXRail, n);
                                var i = {
                                    top: r,
                                    height: e.railYHeight
                                };
                                e.isScrollbarYUsingRight ? e.isRtl ? i.right = e.contentWidth - (e.negativeScrollAdjustment + t.scrollLeft) - e.scrollbarYRight - e.scrollbarYOuterWidth - 9 : i.right = e.scrollbarYRight - t.scrollLeft : e.isRtl ? i.left = e.negativeScrollAdjustment + t.scrollLeft + 2 * e.containerWidth - e.contentWidth - e.scrollbarYLeft - e.scrollbarYOuterWidth : i.left = e.scrollbarYLeft + t.scrollLeft, rt(e.scrollbarYRail, i), rt(e.scrollbarX, {
                            ...
                            }(e, t), t.scrollbarXActive ? e.classList.add(pt.active("x")) : (e.classList.remove(pt.active("x")), t.scrollbarXWidth = 0, t.scrollbarXLeft = 0, e.scrollLeft = !0 === t.isRtl ? t.contentWidth : 0), t.scrollbarYActive ? e.classList.add(pt.active("y")) : (e.classList.remove(pt.active("y")), t.scrollbarYHeight = 0, t.scrollbarYTop = 0, e.scrollTop = 0)
                    }
                    ...
                    function Tt(t, e) {
                        ...
                        function g(e) {
                            e.touches && e.touches[0] && (e[i] = e.touches[0].pageY), h[l] = p + d * (e[i] - f), dt(t, c), xt(t), e.stopPropagation(), e.type.startsWith("touch") && e.changedTouches.length > 1 && e.preventDefault()
                        }

                        function m() {
                            gt(t, c), t[u].classList.remove(pt.clicking), t.event.unbind(t.ownerDocument, "mousemove", g)
                        }

                        function _(e, a) {
                            p = h[l], a && e.touches && (e[i] = e.touches[0].pageY), f = e[i], d = (t[r] - t[n]) / (t[o] - t[s]), a ? t.event.bind(t.ownerDocument, "touchmove", g) : (t.event.bind(t.ownerDocument, "mousemove", g), t.event.once(t.ownerDocument, "mouseup", m), e.preventDefault()), t[u].classList.add(pt.clicking), e.stopPropagation()
                        }
                    ...
                    var Ct = {
                            "click-rail": function(t) {
                                t.element, t.event.bind(t.scrollbarY, "mousedown", (function(t) {
                                    ...
                                    t.element.scrollTop += n * t.containerHeight, xt(t), e.stopPropagation()
                                })), t.event.bind(t.scrollbarX, "mousedown", (function(t) {
                                    return t.stopPropagation()
                                })), t.event.bind(t.scrollbarXRail, "mousedown", (function(e) {
                                    var n = e.pageX - window.pageXOffset - t.scrollbarXRail.getBoundingClientRect().left > t.scrollbarXLeft ? 1 : -1;
                                    t.element.scrollLeft += n * t.containerWidth, xt(t), e.stopPropagation()
                                }))
                            },
                            "drag-thumb": function(t) {
                                Tt(t, ["containerWidth", "contentWidth", "pageX", "railXWidth", "scrollbarX", "scrollbarXWidth", "scrollLeft", "x", "scrollbarXRail"]), Tt(t, ["containerHeight", "contentHeight", "pageY", "railYHeight", "scrollbarY", "scrollbarYHeight", "scrollTop", "y", "scrollbarYRail"])
                            },
                            keyboard: function(t) {
                                var e = t.element;
                                t.event.bind(t.ownerDocument, "keydown", (function(n) {
                                    if (!(n.isDefaultPrevented && n.isDefaultPrevented() || n.defaultPrevented) && (at(e, ":hover") || at(t.scrollbarX, ":focus") || at(t.scrollbarY, ":focus"))) {
                                        ...
                                        t.settings.suppressScrollX && 0 !== i || t.settings.suppressScrollY && 0 !== o || (e.scrollTop -= o, e.scrollLeft += i, xt(t), function(n, r) {
                            ...
                            wheel: function(t) {
                                ...
                                function n(n) {
                                    var r = function(t) {
                                        ...
                                        o = r[1];
                                    if (! function(t, n, r) {
                                            if (!kt.isWebKit && e.querySelector("select:focus")) return !0;
                                            if (!e.contains(t)) return !1;
                                            for (var i = t; i && i !== e;) {
                                                if (i.classList.contains(ht.consuming)) return !0;
                                                var o = nt(i);
                                        ...
                                        var a = !1;
                                        t.settings.useBothWheelAxes ? t.scrollbarYActive && !t.scrollbarXActive ? (o ? e.scrollTop -= o * t.settings.wheelSpeed : e.scrollTop += i * t.settings.wheelSpeed, a = !0) : t.scrollbarXActive && !t.scrollbarYActive && (i ? e.scrollLeft += i * t.settings.wheelSpeed : e.scrollLeft -= o * t.settings.wheelSpeed, a = !0) : (e.scrollTop -= o * t.settings.wheelSpeed, e.scrollLeft += i * t.settings.wheelSpeed), xt(t), (a = a || function(n, r) {
                                            var i = Math.floor(e.scrollTop),
                                                o = 0 === e.scrollTop,
                            ...
                            touch: function(t) {
                                if (kt.supportsTouch || kt.supportsIePointer) {
                                    var e = t.element,
                                        ...
                                        i = {},
                                        o = null;
                                    kt.supportsTouch ? (t.event.bind(e, "touchstart", u), t.event.bind(e, "touchmove", p), t.event.bind(e, "touchend", f)) : kt.supportsIePointer && (window.PointerEvent ? (t.event.bind(e, "pointerdown", u), t.event.bind(e, "pointermove", p), t.event.bind(e, "pointerup", f)) : window.MSPointerEvent && (t.event.bind(e, "MSPointerDown", u), t.event.bind(e, "MSPointerMove", p), t.event.bind(e, "MSPointerUp", f)))
                                }
                                ...
                                function a(n, r) {
                                    var i = Math.floor(e.scrollTop),
                                        ...
                                        s = Math.abs(r);
                                    if (s > a) {
                                        if (r < 0 && i === t.contentHeight - t.containerHeight || r > 0 && 0 === i) return 0 === window.scrollY && r > 0 && kt.isChrome
                                    } else if (a > s && (n < 0 && o === t.contentWidth - t.containerWidth || n > 0 && 0 === o)) return !0;
                                    return !0
                                }

                                function s(n, r) {
                                    e.scrollTop -= r, e.scrollLeft -= n, xt(t)
                                }
                                ...
                                function p(t) {
                                    if (c(t)) {
                                        var e = l(t),
                                            ...
                                            u = o.pageX - n.pageX,
                                            p = o.pageY - n.pageY;
                                        if (h(t.target, u, p)) return;
                                        s(u, p), n = o;
                                        var f = (new Date).getTime(),
                                            d = f - r;
                                        d > 0 && (i.x = u / d, i.y = p / d, r = f), a(u, p) && t.preventDefault()
                                    }
                                }
                        ...
                        Ot = function(t, e) {
                            ...
                            for (var r in this.element = t, t.classList.add(ct), this.settings = {
                            ...
                            this.isRtl = "rtl" === nt(t).direction, !0 === this.isRtl && t.classList.add(ut), this.isNegativeScroll = function() {
                                var e, n = t.scrollLeft;
                                return t.scrollLeft = -1, e = t.scrollLeft < 0, t.scrollLeft = n, e
                            }(), this.negativeScrollAdjustment = this.isNegativeScroll ? t.scrollWidth - t.clientWidth : 0, this.event = new yt, this.ownerDocument = t.ownerDocument || document, this.scrollbarXRail = it(ht.rail("x")), t.appendChild(this.scrollbarXRail), this.scrollbarX = it(ht.thumb("x")), this.scrollbarXRail.appendChild(this.scrollbarX), this.scrollbarX.setAttribute("tabindex", 0), this.event.bind(this.scrollbarX, "focus", i), this.event.bind(this.scrollbarX, "blur", o), this.scrollbarXActive = null, this.scrollbarXWidth = null, this.scrollbarXLeft = null;
                            var a = nt(this.scrollbarXRail);
                            this.scrollbarXBottom = parseInt(a.bottom, 10), isNaN(this.scrollbarXBottom) ? (this.isScrollbarXUsingBottom = !1, this.scrollbarXTop = wt(a.top)) : this.isScrollbarXUsingBottom = !0, this.railBorderXWidth = wt(a.borderLeftWidth) + wt(a.borderRightWidth), rt(this.scrollbarXRail, {
                                display: "block"
                            }), this.railXMarginWidth = wt(a.marginLeft) + wt(a.marginRight), rt(this.scrollbarXRail, {
                                display: ""
                            }), this.railXWidth = null, this.railXRatio = null, this.scrollbarYRail = it(ht.rail("y")), t.appendChild(this.scrollbarYRail), this.scrollbarY = it(ht.thumb("y")), this.scrollbarYRail.appendChild(this.scrollbarY), this.scrollbarY.setAttribute("tabindex", 0), this.event.bind(this.scrollbarY, "focus", i), this.event.bind(this.scrollbarY, "blur", o), this.scrollbarYActive = null, this.scrollbarYHeight = null, this.scrollbarYTop = null;
                            var s = nt(this.scrollbarYRail);
                            this.scrollbarYRight = parseInt(s.right, 10), isNaN(this.scrollbarYRight) ? (this.isScrollbarYUsingRight = !1, this.scrollbarYLeft = wt(s.left)) : this.isScrollbarYUsingRight = !0, this.scrollbarYOuterWidth = this.isRtl ? function(t) {
                                var e = nt(t);
                                return wt(e.width) + wt(e.paddingLeft) + wt(e.paddingRight) + wt(e.borderLeftWidth) + wt(e.borderRightWidth)
                            }(this.scrollbarY) : null, this.railBorderYWidth = wt(s.borderTopWidth) + wt(s.borderBottomWidth), rt(this.scrollbarYRail, {
                                display: "block"
                            }), this.railYMarginHeight = wt(s.marginTop) + wt(s.marginBottom), rt(this.scrollbarYRail, {
                                display: ""
                    ...
                    Ot.prototype.update = function() {
                        this.isAlive && (this.negativeScrollAdjustment = this.isNegativeScroll ? this.element.scrollWidth - this.element.clientWidth : 0, rt(this.scrollbarXRail, {
                            ...
                            display: "block"
                        }), this.railXMarginWidth = wt(nt(this.scrollbarXRail).marginLeft) + wt(nt(this.scrollbarXRail).marginRight), this.railYMarginHeight = wt(nt(this.scrollbarYRail).marginTop) + wt(nt(this.scrollbarYRail).marginBottom), rt(this.scrollbarXRail, {
                            display: "none"
                        }), rt(this.scrollbarYRail, {
                            display: "none"
                        }), xt(this), bt(this, "top", 0, !1, !0), bt(this, "left", 0, !1, !0), rt(this.scrollbarXRail, {
                            display: ""
                        }), rt(this.scrollbarYRail, {
                            display: ""
                        }))
                    }, Ot.prototype.onScroll = function(t) {
                        this.isAlive && (xt(this), bt(this, "top", this.element.scrollTop - this.lastScrollTop), bt(this, "left", this.element.scrollLeft - this.lastScrollLeft), this.lastScrollTop = Math.floor(this.element.scrollTop), this.lastScrollLeft = this.element.scrollLeft)
                    }, Ot.prototype.destroy = function() {
                        this.isAlive && (this.event.unbindAll(), st(this.scrollbarX), st(this.scrollbarY), st(this.scrollbarXRail), st(this.scrollbarYRail), this.removePsClasses(), this.element = null, this.scrollbarX = null, this.scrollbarY = null, this.scrollbarXRail = null, this.scrollbarYRail = null, this.isAlive = !1)
                    ...
                    var Et, Lt, jt = Ot,
                        Rt = {
                            inserted: function(t, e, n) {
                                if (!t.$scrollbar) {
                                    ...
                                    var r = e.value || {};
                                    t.$scrollbar = new jt(t, r), t.style.marginRight = "".concat(-1 * (t.offsetWidth - t.clientWidth), "px"), t.ownerDocument.addEventListener("keydown", (function(e) {
                                        var n = 0;
                            ...
                            methods: {
                                ...
                                checkScriptLoaded: function() {
                                    ...
                                    clearTimeout(this.checkTimeout), setTimeout((function() {
                                        ...
                                        })), t.filteredCategories[0].show = !0, t.activeCategory = t.filteredCategories[0], t.loaded = !0, t.$nextTick((function() {
                        ...
                        It = {
                            bind: function(t, e, n) {
                                ...
                                s && s.position && (r = s.position), a.className = "tawk-tooltip-arrow", o.innerHTML += i, o.className = "tawk-tooltip-hover ".concat(r), o.appendChild(a), t.appendChild(o), t.className += " tawk-tooltip", n.mouseoverHandler = function() {
                                    ...
                                    a.style.cssText += "left:".concat(p - 8, "px;"), "bottom" === r ? c -= l.height + 24 : c += l.height + 4, o.style.cssText += "top : ".concat(c, "px;"), s && s.isDynamic || t.removeEventListener("mouseover", n.mouseoverHandler, !1)
                            ...
                            directives: {
                                ...
                                "click-outside": {
                                    bind: function(t, e, n) {
                                        ...
                                        }, document.addEventListener("click", Et), document.addEventListener("touchstart", Et)
                                    },
                                    unbind: function() {
                                        document.removeEventListener("click", Et), document.removeEventListener("touchstart", Et)
                                    }
                                }
                            }
                        },
                        Dt = (n("75a4"), s($t, (function() {
                            var t = this,
                                e = t._self._c;
                            return e("div", t._b({
                        ...
                        Wt = {
                            ...
                            watch: {
                                isOpen: function(t) {
                                    !0 === t && (console.log(this.$refs.header), this.$refs.leftheader.focus())
                                }
                            },
                            components: {
                                TawkButton: H,
                        ...
                        te = {
                            ...
                            methods: {
                                ...
                                handleInput: function(t) {
                                    this.$emit("input", t.target.value), this.handleTyping(t)
                                },
                            ...
                            directives: {
                                "click-outside": {
                                    bind: function(t, e, n) {
                                        ...
                                        }, document.addEventListener("click", Lt), document.addEventListener("touchstart", Lt)
                                    },
                                    unbind: function() {
                                        document.removeEventListener("click", Lt), document.removeEventListener("touchstart", Lt)
                                    }
                                }
                            }
                        },
                        ee = (n("bb38"), s(te, (function() {
                            var t = this,
                                e = t._self._c;
                            return e("div", t._b({
                        ...
                        ne = {
                            ...
                            methods: {
                                ...
                                handleIsEmpty: function() {
                                    return N.isEmpty(this.$refs.textarea.value) ? (this.$emit("update:error", !0), this.$emit("update:invalidType", "required"), !0) : (this.$emit("update:error", !1), this.$emit("update:invalidType", ""), !1)
                                },
                                handleValidation: function() {
                                    N.isValid({
