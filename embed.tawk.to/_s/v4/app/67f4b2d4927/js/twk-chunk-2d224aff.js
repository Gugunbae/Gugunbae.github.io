        ...
        e0ca: function(t, e, i) {
            ...
            var l = {
                ...
                d = Object(m.a)(l, (function() {
                    ...
                    }, [t._v("Close Chat")]), e("desc", {
                        attrs: {
                            id: "closeIconDesc"
                        }
                    }, [t._v("This icon closes the chat window.")]), e("path", {
                        attrs: {
                            "fill-rule": "evenodd",
                            "clip-rule": "evenodd",
                    ...
                    }, [t._v("Opens Chat")]), e("desc", {
                        attrs: {
                            id: "openIconDesc"
                        }
                    }, [t._v("This icon Opens the chat window.")]), e("path", {
                        attrs: {
                            "fill-rule": "evenodd",
                            "clip-rule": "evenodd",
            ...
            var b = {
                    ...
                    data: function() {
                        return {
                            cssLink: "".concat("https://embed.tawk.to/_s/v4/app/67f4b2d4927", "/css/min-widget.css"),
                            isLoaded: !1,
                            clickEvent: "touchend",
                            resizeWidth: 0,
                    ...
                    computed: g(g({}, Object(o.c)({
                        ...
                        styleObject: function() {
                            ...
                            this.mobileBrowserName ? this.isMobileLandscape ? "safari" === this.mobileBrowserName ? (t = this.xOffsetMobile, e = this.yOffsetMobile) : (t = this.xOffsetMobile / 1.7, e = this.yOffsetMobile / 1.7) : (t = this.xOffsetMobile, e = this.yOffsetMobile) : (t = this.xOffset, e = this.yOffset);
                            var n = t * this.zoomRatio;
                            if (this.isRight ? o["right:"] = "".concat(n, "px !important;") : o["left:"] = "".concat(n, "px !important;"), this.isCenter) {
                                if (o["top:"] = "calc((50% - ".concat(.5 * i.height, "px) + ").concat(e, "px) !important;"), !this.isRoundWidget) {
                                    var s = .5 * i.height - .5 * i.width + t,
                                        a = "49% !important",
                            ...
                            } else this.isBottom ? o["bottom:"] = "".concat(e * this.zoomRatio, "px !important;") : o["top:"] = "".concat(e * this.zoomRatio, "px !important;");
                    ...
                    methods: g(g({}, Object(o.b)({
                        ...
                        scaleContent: function() {
                            var t, e = this.isRTL ? "right" : "left",
                                i = "scale(".concat(this.zoomRatio, ")");
                            t = this.isBottom || this.isCenter ? "bottom" : "top", this.mobileBrowserName && this.isMobileLandscape && ("safari" !== this.mobileBrowserName || "iphone" !== this.os.identity && "mac" !== this.os.identity ? "safari" === this.mobileBrowserName || "iphone" !== this.os.identity && "mac" !== this.os.identity || (i = "scale(".concat(this.zoomRatio / 1.7, ")")) : i = "scale(".concat(1.2 * this.zoomRatio, ")"));
                            var o = "-moz-transform: ".concat(i, ";\n\t\t\t\t\t\t\t-webkit-transform: ").concat(i, ";\n\t\t\t\t\t\t\t-o-transform: ").concat(i, ";\n\t\t\t\t\t\t\t-ms-transform: ").concat(i, ";\n\t\t\t\t\t\t\ttransform: ").concat(i, ";"),
                                n = "-moz-transform-origin: ".concat(t, " ").concat(e, ";\n\t\t\t\t\t\t\t\t-webkit-transform-origin: ").concat(t, "  ").concat(e, ";\n\t\t\t\t\t\t\t\t-o-transform-orgin: ").concat(t, "  ").concat(e, ";\n\t\t\t\t\t\t\t\t-ms-transform-origin: ").concat(t, "  ").concat(e, ";\n\t\t\t\t\t\t\t\ttransform-origin: ").concat(t, "  ").concat(e);
                            ...
                            this.mobileBrowserName && !this.isRoundWidget && setTimeout((function() {
                                if (t.$refs && t.$refs["min-content"] && t.$refs["min-content"].$refs) {
                                    ...
                                    if (e && i) {
                                        ...
                                        var o = e.clientWidth + i.clientWidth + 8;
