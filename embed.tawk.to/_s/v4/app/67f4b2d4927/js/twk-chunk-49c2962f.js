        ...
        3519: function(t, e, a) {
            ...
            function l() {
                ...
                var t, e = {},
                    a = Object.prototype,
                    r = a.hasOwnProperty,
                    i = Object.defineProperty || function(t, e, a) {
                        t[e] = a.value
                    },
                ...
                function $(e, a, r) {
                    ...
                    return function(n, s) {
                        ...
                        for (r.method = n, r.arg = s;;) {
                            ...
                            var l = m(e, a, r);
                            if ("normal" === l.type) {
                                if (i = r.done ? g : "suspendedYield", l.arg === b) continue;
                                return {
                                    value: l.arg,
                                    done: r.done
                                }
                ...
                function _(e, a) {
                    var r = a.method,
                        i = e.iterator[r];
                    if (i === t) return a.delegate = null, "throw" === r && e.iterator.return && (a.method = "return", a.arg = t, _(e, a), "throw" === a.method) || "return" !== r && (a.method = "throw", a.arg = new TypeError("The iterator does not provide a '" + r + "' method")), b;
                    var n = m(i, e.iterator, a.arg);
                    if ("throw" === n.type) return a.method = "throw", a.arg = n.arg, a.delegate = null, b;
                    var s = n.arg;
                    return s ? s.done ? (a[e.resultName] = s.value, a.next = e.nextLoc, "return" !== a.method && (a.method = "next", a.arg = t), a.delegate = null, b) : s : (a.method = "throw", a.arg = new TypeError("iterator result is not an object"), a.delegate = null, b)
                }
                ...
                return v.prototype = y, i(S, "constructor", {
                    value: y,
                    configurable: !0
                }), i(y, "constructor", {
                    value: v,
                    ...
                    return Object.setPrototypeOf ? Object.setPrototypeOf(t, y) : (t.__proto__ = y, d(t, u, "GeneratorFunction")), t.prototype = Object.create(S), t
                }, e.awrap = function(t) {
                    return {
                        __await: t
                    }
                }, T(C.prototype), d(C.prototype, o, (function() {
                    return this
                })), e.AsyncIterator = C, e.async = function(t, a, r, i, n) {
                    void 0 === n && (n = Promise);
                    var s = new C(h(t, a, r, i), n);
                    return e.isGeneratorFunction(a) ? s : s.next().then((function(t) {
                        return t.done ? t.value : s.next()
                    }))
                }, T(S), d(S, u, "Generator"), d(S, s, (function() {
                    return this
                    ...
                    reset: function(e) {
                        if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(P), !e)
                            for (var a in this) "t" === a.charAt(0) && r.call(this, a) && !isNaN(+a.slice(1)) && (this[a] = t)
                    },
                    stop: function() {
                        this.done = !0;
                    ...
                    dispatchException: function(e) {
                        ...
                        function i(r, i) {
                            return o.type = "throw", o.arg = e, a.next = r, i && (a.method = "next", a.arg = t), !!i
                        }
                    ...
                    finish: function(t) {
                        for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                            ...
                            if (a.finallyLoc === t) return this.complete(a.completion, a.afterLoc), P(a), b
                        }
                    },
                    catch: function(t) {
                        for (var e = this.tryEntries.length - 1; e >= 0; --e) {
            ...
            var f = {
                    ...
                    watch: {
                        isNotValidEmail: function(t) {
                            ...
                            this.formFields.forEach((function(a) {
                                "email" === a.type && null != e.isNotValidEmail && (a.invalidType = t)
                            }))
                        },
                        name: function(t, e) {
                            ...
                            return d(l().mark((function e() {
                                ...
                                return l().wrap((function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        ...
                                        case 2:
                                            if (a = e.sent, r = a.formData, !(i = a.error) || !i.hasError && !i.message) {
                                                e.next = 8;
                                                break
                                            }
                                            return t.$emit("update:submissionError", null == i ? void 0 : i.message), e.abrupt("return");
                                        case 8:
                                            t.$emit("update:submissionError", ""), t.$emit("submit", r);
                                        case 10:
                                        case "end":
                                            return e.stop()
                                    }
                            ...
                            return d(l().mark((function e() {
                                return l().wrap((function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        ...
                                        case 2:
                                            return t.formFields = e.sent, e.next = 5, t.formFields.forEach((function(e) {
                ...
                p = Object(s.a)(f, (function() {
                    ...
                    return e("div", {
                        ...
                        }) : t._e(), "name" === a.type || "email" === a.type || "phone" === a.type ? e("tawk-input", {
                            ref: a.id,
                            refInFor: !0,
                            staticClass: "tawk-margin-xsmall-top tawk-margin-xsmall-bottom",
                            attrs: {
                        ...
                        }) : t._e(), "textarea" === a.type || "message" === a.type ? e("tawk-textarea", {
                            ref: a.id,
                            refInFor: !0,
                            staticClass: "tawk-margin-xsmall-top tawk-margin-xsmall-bottom",
                            attrs: {
                        ...
                        }) : t._e(), "radio" === a.type ? e("tawk-radio", {
                            ref: a.id,
                            refInFor: !0,
                            staticClass: "tawk-margin-xsmall-top tawk-margin-xsmall-bottom",
                            attrs: {
                        ...
                        }) : t._e(), "checkbox" === a.type ? e("tawk-checkbox", {
                            ref: a.id,
                            refInFor: !0,
                            staticClass: "tawk-margin-xsmall-top tawk-margin-xsmall-bottom",
                            attrs: {
                        ...
                        }, [t._v(" " + t._s(a.label) + " ")]) : t._e(), t._l(a.selections, (function(a, r) {
                            return e("option", {
                                key: r,
                                domProps: {
                                    value: a.label
                    ...
                    }), t._v(" " + t._s(t.$i18n("form", "submit_button")) + " ")]], 2)], 1)
                }), [], !1, null, null, null).exports,
                g = a("bdd0"),
                b = a("5868");
            ...
            function v() {
                ...
                function C(t, e) {
                    function a(i, n, s, o) {
                        ...
                        if ("throw" !== c.type) {
                            var l = c.arg,
                                u = l.value;
                            return u && "object" == w(u) && r.call(u, "__await") ? e.resolve(u.__await).then((function(t) {
                                a("next", t, s, o)
                            }), (function(t) {
                                a("throw", t, s, o)
                ...
                function $(e, a, r) {
                    ...
                    return function(n, s) {
                        ...
                        for (r.method = n, r.arg = s;;) {
                            ...
                            var l = d(e, a, r);
                            if ("normal" === l.type) {
                                if (i = r.done ? f : "suspendedYield", l.arg === p) continue;
                                return {
                                    value: l.arg,
                                    done: r.done
                                }
                            }
                            "throw" === l.type && (i = f, r.method = "throw", r.arg = l.arg)
                        }
                    }
                }
                ...
                function _(e, a) {
                    var r = a.method,
                        i = e.iterator[r];
                    if (i === t) return a.delegate = null, "throw" === r && e.iterator.return && (a.method = "return", a.arg = t, _(e, a), "throw" === a.method) || "return" !== r && (a.method = "throw", a.arg = new TypeError("The iterator does not provide a '" + r + "' method")), p;
                    var n = d(i, e.iterator, a.arg);
                    if ("throw" === n.type) return a.method = "throw", a.arg = n.arg, a.delegate = null, p;
                    var s = n.arg;
                    return s ? s.done ? (a[e.resultName] = s.value, a.next = e.nextLoc, "return" !== a.method && (a.method = "next", a.arg = t), a.delegate = null, p) : s : (a.method = "throw", a.arg = new TypeError("iterator result is not an object"), a.delegate = null, p)
                }
                ...
                return b.prototype = y, i(S, "constructor", {
                    ...
                    value: b,
                    configurable: !0
                }), b.displayName = l(y, c, "GeneratorFunction"), e.isGeneratorFunction = function(t) {
                    var e = "function" == typeof t && t.constructor;
                    return !!e && (e === b || "GeneratorFunction" === (e.displayName || e.name))
                }, e.mark = function(t) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(t, y) : (t.__proto__ = y, l(t, c, "GeneratorFunction")), t.prototype = Object.create(S), t
                }, e.awrap = function(t) {
                    return {
                        __await: t
                    }
                ...
                }, T(S), l(S, c, "Generator"), l(S, s, (function() {
                    return this
                    ...
                    abrupt: function(t, e) {
                        ...
                        n && ("break" === t || "continue" === t) && n.tryLoc <= e && e <= n.finallyLoc && (n = null);
                        var s = n ? n.completion : {};
                        return s.type = t, s.arg = e, n ? (this.method = "next", this.next = n.finallyLoc, p) : this.complete(s)
                    },
                    complete: function(t, e) {
                        if ("throw" === t.type) throw t.arg;
                    ...
                    finish: function(t) {
                        for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                            var a = this.tryEntries[e];
                            if (a.finallyLoc === t) return this.complete(a.completion, a.afterLoc), P(a), p
                        }
                    },
                    catch: function(t) {
                        for (var e = this.tryEntries.length - 1; e >= 0; --e) {
            ...
            var T = {
                    ...
                    watch: {
                        ...
                        email: function(t, e) {
                            t !== e && (this.ticketForm.email = t, this.leadForm.email = t)
                        }
                    },
                    computed: O(O({}, Object(r.c)({
                        name: "visitor/name",
                        email: "visitor/getEmailValue",
                        ...
                        getLeadForm: function() {
                            ...
                            if (this.msg.leadFormRef) {
                                ...
                                return (null == e || null === (t = e.content) || void 0 === t ? void 0 : t.fields) || []
                            }
                        }
                    }),
                    methods: {
                        handleAttachmentProps: function(t) {
                            return k(v().mark((function e() {
                                var a, r;
                                return v().wrap((function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        case 0:
                                            return a = t.fileType, r = {}, e.next = 4, t.attachments.forEach((function(e) {
                                                "image" === e.type ? r.images.push({
                                                    source: e.fileLink,
                                                    name: e.fileName
                                                }) : "video" === a ? r.videos.push({
                                                    name: t.fileName,
                                                    source: "selfhosted",
                                                    url: t.fileLink,
                                                    options: {
                        ...
                        sendTicketForm: function() {
                            ...
                            return k(v().mark((function e() {
                                ...
                                return v().wrap((function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        case 0:
                                            if (t.ticketForm.submissionError = null, t.$refs["ticket-name-input"] && t.$refs["ticket-name-input"].validate(), t.$refs["ticket-email-input"] && t.$refs["ticket-email-input"].validate(), t.$refs["ticket-phone-input"] && t.$refs["ticket-phone-input"].validate(), t.$refs["ticket-subject-input"] && t.$refs["ticket-subject-input"].validate(), t.$refs["ticket-message-input"] && t.$refs["ticket-message-input"].validate(), !(t.ticketForm.invalid.name || t.ticketForm.invalid.email || t.ticketForm.invalid.subject || t.ticketForm.invalid.message)) {
                                                e.next = 8;
                                                break
                                            }
                                            return e.abrupt("return");
                                        case 8:
                                            return t.ticketForm.isSubmitting = !0, e.prev = 9, e.next = 12, t.$store.dispatch("session/checkTokenValidity");
                                        case 12:
                                            e.next = 18;
                                            break;
                                        case 14:
                                            return e.prev = 14, e.t0 = e.catch(9), console.error("[JSAPI/Login]", e.t0), e.abrupt("return");
                                        case 18:
                                            (a = t.$TawkSessionManager.getStoredToken()) && (r = {
                                                "X-Tawk-Token": a
                                            }), i = {
                                            ...
                                            }, g.a.post("".concat("https://va.tawk.to", "/v1/ticket/create"), i, r, (function(e, a) {
                                                if (e || a.error) {
                                                    if (t.ticketForm.isSubmitting = !1, a && a.error) {
                                                        if ("InternalServerError" === a.error.code) return void(t.ticketForm.submissionError = "The server is unavailable. Please try again.");
                                                        if ("TooManyRequestsError" === a.error.code) return void(t.ticketForm.submissionError = "You have made too many requests.");
                                                        if ("GoneError" === a.error.code) return void(t.ticketForm.submissionError = "Property is not available");
                                                        if ("NotFoundError" === a.error.code) return void(t.ticketForm.submissionError = "Session not found")
                                                    }
                                                    t.ticketForm.submissionError = "Unable to submit form. Please try again"
                                                } else t.ticketForm.isSubmitting = !1, t.ticketForm.submissionSuccess = !0, t.$store.commit("chat/setFormRefs", {
                        ...
                        sendLeadForm: function(t) {
                            var e = this;
                            return k(v().mark((function a() {
                                var r, i, n;
                                return v().wrap((function(a) {
                                    for (;;) switch (a.prev = a.next) {
                                        case 0:
                                            return e.leadForm.isSubmitting = !0, e.leadForm.submissionError = null, a.prev = 2, a.next = 5, e.$store.dispatch("session/checkTokenValidity");
                                        case 5:
                                            a.next = 11;
                                            break;
                                        case 7:
                                            return a.prev = 7, a.t0 = a.catch(2), console.error("[JSAPI/Login]", a.t0), a.abrupt("return");
                                        case 11:
                                            (r = e.$TawkSessionManager.getStoredToken()) && (i = {
                                                "X-Tawk-Token": r
                                            }), 0 === (null == (n = O({
                                                referenceId: e.msg.leadFormRef
                                            }, t)) ? void 0 : n.additionalInfo.length) && delete n.additionalInfo, g.a.post("".concat("https://va.tawk.to", "/v1/form/lead-capture/submit"), n, i, (function(t, a) {
                                                if (t || a.error) {
                                                    if (e.leadForm.isSubmitting = !1, a && a.error) {
                                                        if ("BadRequestError" === a.error.code) return void(e.leadForm.submissionError = "Invalid parameters");
                                                        if ("NotFoundError" === a.error.code) return void(e.leadForm.submissionError = "Form reference not found.");
                                                        if ("ConflictError" === a.error.code) return void(e.leadForm.submissionError = "Form already submitted");
                                                        if ("InternalServerError" === a.error.code) return void(e.leadForm.submissionError = "The server is unavailable. Please try again.")
                                                    }
                                                    e.leadForm.submissionError = "Unable to submit form. Please try again"
                                                } else e.leadForm.isSubmitting = !1, e.leadForm.submissionSuccess = !0, e.$store.commit("chat/setFormRefs", {
                        ...
                        parseMDToHTML: function(t) {
                            try {
                                var e, a = this.$TawkWindow.makeHtml(t);
                                return ((a = a.replace(b.a.regLineBreaks, b.a.br)) instanceof Error || void 0 === a) && this.$TawkLogger.reportError({
                                    error: a,
                                    source: {
                ...
                C = Object(s.a)(T, (function() {
                    ...
                    return e("div", {
                    ...
                    }, [t._v(t._s(t.$i18n("chat", "new_messages")))]), e("hr")])]) : t._e(), "c" === t.msg.type ? [e("div", {
                    ...
                    }) : t._e()], 1) : t._e(), "v" !== t.msg.senderType && t.msg.ticketFormRef ? e("div", [t.hasTicketFormSubmit || t.ticketForm.submissionSuccess ? [e("div", {
                        staticClass: "tawk-chat-alert"
                    }, [e("div", {
                        staticClass: "tawk-chat-alert-content"
                    }, [e("p", {
                        staticClass: "tawk-text-regular-2"
                    }, [t._v(t._s(t.$i18n("form", "ticket_form_success_message")))]), e("tawk-timeago", {
                        ...
                        attrs: {
                            ...
                            errorMessage: {
                                required: t.$i18n("form", "required_error_message")
                            }
                        },
                        on: {
                            "update:invalidType": function(e) {
                        ...
                        attrs: {
                            ...
                            errorMessage: {
                                required: t.$i18n("form", "required_error_message"),
                                email: t.$i18n("form", "email_error_message")
                            }
                        },
                        on: {
                            "update:invalidType": function(e) {
                    ...
                    }), t._v(" " + t._s(t.$i18n("form", "submit_button")) + " ")]], 2)]], 2) : t._e(), "v" !== t.msg.senderType && t.msg.leadFormRef ? e("div", [t.hasLeadFormSubmit || t.leadForm.submissionSuccess ? [e("div", {
                        staticClass: "tawk-chat-alert"
                    }, [e("div", {
                        staticClass: "tawk-chat-alert-content"
                    }, [e("p", {
                        staticClass: "tawk-text-regular-2"
                    }, [t._v(t._s(t.$i18n("form", "lead_form_success_message")))]), e("tawk-timeago", {
                        staticClass: "tawk-margin-xsmall-top",
                        attrs: {
                            datetime: t.msg.time,
                            isLive: !0,
                    ...
                    })], 1)])] : [t.getLeadForm.length ? e("tawk-inline-form", {
                        attrs: {
                            form: t.getLeadForm,
                            isSubmitting: t.leadForm.isSubmitting,
                            submissionError: t.leadForm.submissionError
                        },
                        on: {
                            "update:submissionError": function(e) {
                                return t.$set(t.leadForm, "submissionError", e)
                            },
                            "update:submission-error": function(e) {
                                return t.$set(t.leadForm, "submissionError", e)
                            },
                            submit: t.sendLeadForm
                        }
                    }) : t._e()]], 2) : t._e()]], 2), "v" !== t.msg.senderType ? e("div", {
                        staticClass: "tawk-flex-none",
                        staticStyle: {
                            "min-width": "40px"
                        }
            ...
            function P(t) {
                for (var e = 1; e < arguments.length; e++) {
                    ...
                    e % 2 ? j(Object(a), !0).forEach((function(e) {
                        E(t, e, a[e])
                    })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(a)) : j(Object(a)).forEach((function(e) {
                        Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(a, e))
                    }))
                }
                return t
                ...
                if (!a) {
                    if (Array.isArray(t) || (a = function(t, e) {
                            if (t) {
                                ...
                                return "Object" === a && t.constructor && (a = t.constructor.name), "Map" === a || "Set" === a ? Array.from(t) : "Arguments" === a || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(a) ? F(t, e) : void 0
                            }
            ...
            var L = {
                    ...
                    methods: {
                        ...
                        callDescription: function(t) {
                            var e = new Date(t.startedAt),
                                ...
                                r = e.getMinutes();
                            if (t.isDone) {
                                if (a < 10 && (a = "0" + a), r < 10 && (r = "0" + r), t.isRejected || t.isMissed) return this.$i18n("chat", "call_started_on", {
                                    startedOn: "".concat(a, ":").concat(r)
                                });
                                var i, n, s, o = 6e4,
                                    c = 60 * o,
                                    l = new Date(t.endedAt).getTime() - new Date(t.startedAt).getTime();
                                return l >= c ? (i = Math.round(l / c), s = "hours") : l >= o ? (i = Math.round(l / o), s = "minutes") : (i = Math.round(l / 1e3), s = "seconds"), n = this.$i18n("chat", s, {
                                    num: i
                        ...
                        getMessageBlockClasses: function(t) {
                            ...
                            if (e + 1 < this.messageBlocks.length) {
                                ...
                                if ("v" === t.senderType && "a" === a.senderType && 1 === a.messages.length && !this.showSender(a.messages)) return "tawk-flex tawk-flex-bottom tawk-message-block";
                                if ("a" === t.senderType && 1 === t.messages.length && !this.showSender(t.messages)) return "tawk-flex tawk-flex-bottom tawk-message-block"
                            }
                            ...
                            if (this.messageBlocks.length) {
                                ...
                                if ("call" !== r.messageType && r.messages.length) {
                                    var i = r.messages.length - 1,
                                        n = r.messages[i];
                                    n.surveyObj && ((e = n.surveyObj).senderType = n.senderType, this.$nextTick((function() {
                                        t.$eventBus.$emit("updateScrollPosition")
                                    })))
                                }
                            }
                ...
                M = Object(s.a)(L, (function() {
                    ...
                    return e("div", {
                        ...
                        return e("div", {
                        ...
                        }, ["call" === a.messageType ? [a.callData && !a.callData.hasError ? e("div", {
                        ...
                        }, [t._v(" " + t._s(t.callTitle(a.callData)) + " ")]), e("p", {
                            staticClass: "tawk-text-regular-1 tawk-text-grey-2"
                        }, [t._v(" " + t._s(t.callDescription(a.callData)) + " ")])])]) : e("div", {
                            ...
                            staticClass: "tawk-chat-alert-content"
                        }, [e("p", [t._v(t._s(t.$i18n("chat", "error_title")))]), e("p", [t._v(t._s(t.$i18n("chat", "call_error_load")))])])])] : ["c" === a.messageType && "v" !== a.senderType && t.showSender(a.messages) ? e("tawk-avatar", {
                            ...
                            }, [a.message && a.message.length || a.ticketFormRef || a.leadFormRef || a.attchs ? e("chat-message-bubble", {
                                attrs: {
                                    msg: a,
        ...
        "38d6": function(t, e, a) {
            ...
            var u = {
                ...
                h = Object(d.a)(u, (function() {
                    var t = this,
                        e = t._self._c;
                    return t.refreshHeader ? e("div", t._l(t.header, (function(a, r) {
                        return e("div", {
                            key: r
                        }, ["logo" === a.type ? e("div", {
                ...
                n = {
                    ...
                    methods: {
                        displayMessages: function(t) {
                            ...
                            if (d.length > 0 && "c" === n.type && ((e = d[d.length - 1]).ownerId === n.ownerId ? (n.blockId = e.blockId, e.messages.push(n)) : e = null), n.timeStamp > this.lastMessageTimestamp && ("v" === n.senderType ? this.$store.dispatch("session/updateVisitorChatSeen", n.timeStamp) : (this.unseenMessages.push(n), "chat" === this.currentRoute && u && !this.isLoading || this.barMessageId || (n.showBar = !0, this.barMessageId = n.messageId, this.barMessageRerence = n))), o && "a" === n.senderType && n.data && n.data.rsc && this.removeAgentIsTyping(n.data.rsc), n.isCallView) {
                                ...
                                n.blockId = f.blockId, l ? this.$store.dispatch("chat/addMessageBlock", f) : this.$store.dispatch("history/addMessageBlock", f)
                            }
        ...
        d6a3: function(t, e, a) {
            ...
            var u = {
                ...
                h = Object(d.a)(u, (function() {
                    ...
                    return e("div", {
                        ...
                        staticClass: "tawk-text-left tawk-flex tawk-flex-middle",
                        attrs: {
                            label: t.$i18n("menu", "email_transcript"),
                            isText: !0,
                            size: "small",
                            role: "button",
                            tabindex: t.isOpen ? 0 : -1
                        ...
                        staticClass: "tawk-text-left tawk-flex tawk-flex-middle",
                        attrs: {
                            label: t.$i18n("menu", "popout_widget"),
                            isText: !0,
                            size: "small",
                            role: "button",
                            tabindex: t.isOpen ? 0 : -1
                        ...
                        staticClass: "tawk-text-left tawk-flex tawk-flex-middle",
                        attrs: {
                            label: t.$i18n("menu", "end_chat_session"),
                            isText: !0,
                            size: "small",
                            role: "button",
                            tabindex: t.isOpen ? 0 : -1
                        ...
                        staticClass: "tawk-text-left tawk-flex tawk-flex-middle",
                        attrs: {
                            label: t.$i18n("menu", "add_chat_to_your_website"),
                            href: t.branding.url,
                            target: "blank",
                            isText: !0,
                            size: "small",
            ...
            var T = {
                    ...
                    components: {
                        ...
                        Conversations: function() {
                            return Promise.all([a.e("vendor"), a.e("chunk-2d0b9056")]).then(a.bind(null, "30be"))
                        },
            ...
            var E = {
                ...
                B = Object(d.a)(E, (function() {
                    ...
                    })], 1)], 1) : t._e(), t._l(t.body, (function(a, r) {
                ...
                X = {
                    ...
                    methods: {
                        beautifyFilename: function(t, e) {
                            ...
                            return r.length > 7 && (i = r.substring(r.length - 3) + i, r = r.substring(0, r.length - 3)), '<span class="tawk-text-truncate">'.concat(r, '</span><span class="tawk-flex-none">').concat(i, '</span><span class="tawk-flex-none">&nbsp;(').concat(e, ")</span>")
                        }
                    }
                },
                Y = Object(d.a)(X, (function() {
                    var t = this,
                        e = t._self._c;
                    return e("div", {
            ...
            var at = {
                    ...
                    mounted: function() {
                        ...
                        this.processChatMessages(), this.showAgentTyping && (this.$eventBus.$on("agentIsTyping", (function(e) {
                            ...
                            a && (t.updateAgentTyping(e, a), t.updateScrollbar()), r && t.scrollToBottom()
                            ...
                            for (var a = t.isScrollBarBottom(), r = 0; r < t.messageBlocks.length; r++) {
                    ...
                    methods: tt(tt({}, Object(r.b)({
                        ...
                        scrollToEl: function(t) {
                            ...
                            if (t) {
                                ...
                                r && r.length && i ? (void 0 !== r[0].offsetTop ? i.scrollTop = r[0].offsetTop - 40 : i.scrollTop = r[0].offsetTop, this.$refs["tawk-chat-panel"] && this.$refs["tawk-chat-panel"].$scrollbar && this.$refs["tawk-chat-panel"].$scrollbar.update(), e()) : e(r)
                            }
                        },
                                ...
                                if (t.showNotification = !1, t.barMessageRerence && t.barMessageId) {
                                    ...
                                    if (a && a.$refs[t.barMessageId] && (e = a.$refs[t.barMessageId]), e)
                                        if (t.chatElementInView(e)) t.clearBarMessageId();
                                            ...
                                            r && r.scrollTop < e[0].offsetTop && (t.showNotification = !0)
                                        }
                                }
                        ...
                        processChatMessages: function() {
                            ...
                            for (var a in this.clearMessageBlock(), this.chatMessages) {
                                ...
                                this.outgoingMessage && !e && r.messageId === this.outgoingMessage.messageId ? (e = !0, this.displayMessages({
                                    message: r,
                                    isIncoming: !0
                                })) : this.displayMessages({
                                    message: r
                ...
                rt = Object(d.a)(at, (function() {
                    ...
                    }, [t._v(" " + t._s(t.$i18n("chat", "new_message", {
            ...
            function st(t) {
                for (var e = 1; e < arguments.length; e++) {
                    ...
                    e % 2 ? nt(Object(a), !0).forEach((function(e) {
                        ot(t, e, a[e])
                    })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(a)) : nt(Object(a)).forEach((function(e) {
                        Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(a, e))
                    }))
                }
                return t
            ...
            var ct = {
                    ...
                    methods: st(st({}, Object(r.b)({
                        ...
                        submitForm: function(t) {
                            var e = this;
                            t.hasError || (this.isSubmitting = !0, this.submissionError = !1, this.submissionSuccess = !1, this.$store.commit("session/setIsNotValidEmail", null), this.$socket.publish("notifyPrechat", t.formData, (function(a) {
                                var r = "";
                                if (e.isSubmitting = !1, a) return "InvalidArgument" === a.code && "email" === a.message ? (e.$store.commit("session/setIsNotValidEmail", "email"), void e.$emit("update:isSubmitting", !1)) : void(e.submissionError = !0);
                                e.$store.commit("session/setPrechatSubmitted", !0), e.$TawkJSAPI.triggerApiHandlers("onPrechatSubmit", t.formData.questions), e.$nextTick((function() {
                                    if (t.formData.questions && t.formData.questions.length > 0)
                                        for (var a = 0, i = t.formData.questions.length; a < i; a++) r += "".concat(t.formData.questions[a].label, " : ").concat(t.formData.questions[a].answer), a !== i - 1 && (r += "\r\n");
                                    r && e.$TawkChatManager.sendMessageToServer({
                                        message: r
            ...
            function mt(t) {
                for (var e = 1; e < arguments.length; e++) {
                    ...
                    e % 2 ? ht(Object(a), !0).forEach((function(e) {
                        ft(t, e, a[e])
                    })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(a)) : ht(Object(a)).forEach((function(e) {
                        Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(a, e))
                    }))
                }
                return t
            ...
            var pt = {
                    ...
                    data: function() {
                        return {
                            cssLink: "".concat("https://embed.tawk.to/_s/v4/app/67f4b2d4927", "/css/max-widget.css"),
                            classString: "",
                            showEndChat: !1,
                            noZoomMetaTag: null,
                            resizeHeightTo: null,
                        ...
                        styleObject: function() {
                            ...
                            if (this.isWindowed || this.isEmbedded ? a["position:"] = "absolute !important;" : a["position:"] = "fixed !important;", this.isWindowed || this.mobileBrowserName || this.isEmbedded) {
                                var r = 0,
                                    ...
                                    n = 0,
                                    s = 0;
                                this.mobileBrowserName && e && e.mobile && e.mobile.maximized && (e.mobile.maximized.bottomOffset && (r = e.mobile.maximized.bottomOffset), e.mobile.maximized.topOffset && (s = e.mobile.maximized.topOffset), e.mobile.maximized.leftOffset && (n = e.mobile.maximized.leftOffset), e.mobile.maximized.rightOffset && (i = e.mobile.maximized.rightOffset), a["height:"] = "calc(100% - ".concat(r + s, "px) !important;"), a["min-height:"] = "calc(100% - ".concat(r + s, "px) !important;"), a["max-height:"] = "calc(100% - ".concat(r + s, "px) !important;"), a["width:"] = "calc(100% - ".concat(n + i, "px) !important;"), a["min-width:"] = "calc(100% - ".concat(n + i, "px) !important;"), a["max-width:"] = "calc(100% - ".concat(n + i, "px) !important;")), a["bottom:"] = "".concat(r, "px !important;"), a["right:"] = "".concat(i, "px !important;"), a["left:"] = "".concat(n, "px !important;"), a["top:"] = "".concat(s, "px !important;")
                            } else {
                                var o;
                                o = "slide" === this.onClick ? 0 : this.isCenter && this.isRoundWidget ? this.minDesktop.width + this.xOffset + 10 : this.xOffset - 10, this.isRight ? a["right:"] = "".concat(o, "px !important;") : a["left:"] = "".concat(o, "px !important;"), this.isRoundWidget && "slide" !== this.onClick ? this.isBottom ? a["bottom:"] = "".concat(this.minDesktop.height + this.yOffset + 10, "px !important;") : (a["top:"] = "".concat(this.minDesktop.height + this.yOffset + 10, "px !important;"), a["bottom:"] = "auto !important;") : a["bottom:"] = "0px !important;"
                            }
                            return "max" === this.chatWindowState || this.isWindowed || this.isEmbedded ? a["display:"] = "block !important;" : a["display:"] = "none !important;", mt(mt({}, this.genericStyles), a)
                        },
                    ...
                    methods: mt(mt({}, Object(r.b)({
                        ...
                        openView: function() {
                            if (this.initialized = !0, this.showMaxWidget(), this.mobileBrowserName) {
                                ...
                                for (var a = ["height", "min-height", "max-height", "width", "min-width", "max-width"], r = 0; r < a.length; r++) e.style.setProperty(a[r], "100%", "important");
                        ...
                        loaded: function() {
                            ...
                            if (this.hasHomeView || (this.updateRoute({
                                ...
                                r += "@keyframes " + i + c, r += "@-moz-keyframes " + i + c, r += "@-webkit-keyframes " + i + c, r += "#" + s + ".open{animation : " + i + " .25s ease!important;}", this.mobileBrowserName || (this.isRoundWidget, r += "@keyframes " + n + (o = "{from{opacity: 1;" + a + ";}to{opacity: 0;" + e + ";}}"), r += "@-moz-keyframes " + n + o, r += "@-webkit-keyframes " + n + o, r += "#" + s + ".closed{animation: " + n + " .25s ease!important}");
                                var l = document.head,
                                    u = document.createDocumentFragment(),
                                    d = document.createElement("style"),
                                    h = document.createTextNode(r);
                                d.type = "text/css", u.appendChild(d), l.appendChild(u), d.styleSheet ? d.styleSheet.cssText = h.nodeValue : d.appendChild(h)
                            }
                        ...
                        resizeFrame: function() {
                            ...
                            this.isWindowed || this.mobileBrowserName || this.isEmbedded || setTimeout((function() {
                                if (!t.isOverlayOpen && t.$refs["main-toolbar"] && t.$refs["main-toolbar"].$el && (e = t.$refs["main-toolbar"].$el.offsetHeight), t.isOverlayOpen && t.$refs["view-overlay"] && t.$refs["view-overlay"].$el.children[0] && (e = t.$refs["view-overlay"].$el.children[0].offsetHeight), !t.isOverlayOpen && t.$refs["main-footer"] && (a = t.$refs["main-footer"].$el.offsetHeight), t.isOverlayOpen && t.$refs["overlay-footer"] && (a = t.$refs["overlay-footer"].$el.offsetHeight), t.$refs["router-view"] && t.$refs["router-view"].$children.length) {
                                    ...
                                    i && i.$refs && i.$refs["tawk-inner-panel"] && (r = i.$refs["tawk-inner-panel"].offsetHeight)
                                }
                                if (!t.$refs["router-view"].$children.length) {
                                    ...
                                    if (s && 0 === s.offsetHeight) return t.resizeHeightTo = null;
                                    r = n ? n.offsetHeight : 0
                                }
                                return 0 === r ? t.resizeHeightTo = null : (r < 250 && (r = 250), 0 === r ? t.resizeHeightTo = null : void((r += e + a) && t.maxDimension.height > r + 10 && (t.resizeHeightTo = r + 10)))
                            }), 300)
                        },
                    ...
                    mounted: function() {
                        ...
                        this.calculateIframeSize(), this.noZoomMetaTag = document.createElement("meta"), this.noZoomMetaTag.name = "viewport", this.checkRouteLoaded(), this.$el.contentWindow.addEventListener("focus", this.handleFocus), this.$el.contentWindow.addEventListener("blur", this.handleBlur), window.addEventListener("resize", this.calculateIframeSize), this.$eventBus.$on("switchWidget", (function() {
                            t.key = i.Helper.generateUUID(), t.calculateIframeSize(), t.$nextTick((function() {
                                t.injectStyleNode()
                            }))
                ...
                n = {
                    methods: {
                        ...
                        formatFields: function(t) {
                            for (var e = [], a = 0; a < t.length; a++) {
                                var i = t[a],
                                    n = {},
                                    s = "";
                                if (i.required && (n.required = this.$i18n("form", "required_error_message")), i.context && "email" === i.context && (n.email = this.$i18n("form", "email_error_message"), s = this.email), i.context && "name" === i.context && (s = this.name), i.context && "phone" === i.context && (n.phone = this.$i18n("form", "phone_error_message")), "department" === i.context && this.departments.length) {
                                    for (var o = {
                                            online: [],
                                            offline: []
                        ...
                        formatFormData: function() {
                            ...
                            for (var a = 0; a < this.formFields.length; a++) {
                                var r = this.formFields[a],
                                    n = r.value || "";
                                if ("string" == typeof n && (n = n.trim()), "name" === r.type) t.name = n;
                                else if ("email" === r.type) t.email = n;
                                else if ("phone" === r.type && n.length > 0) n = n.replace(/[- )(]/g, ""), t.phone = n;
                                else if ("department" === r.type) {
                                    if (r.isRequired && !this.selectedDepartment) {
                                        if (!r.selections || !r.selections.online.length && !r.selections.offline.length) continue;
                                        r.isError = !0, e = !0;
                                        continue
                                    }
                                ...
                                r.isRequired && 0 === n.length && "department" !== r.type && (this.$refs[r.id] && this.$refs[r.id].length && this.$refs[r.id][0] && this.$refs[r.id][0].validate && this.$refs[r.id][0].validate(), e = !0), r.isError ? e = !0 : n && n.length && ("string" == typeof n ? t.questions.push({
                                    label: i.a.rawDecode(r.label),
                                    answer: n
                                }) : t.questions.push({
                                    label: i.a.rawDecode(r.label),
                        ...
                        formatInlineFormData: function() {
                            for (var t = {
                                    additionalInfo: []
                                }, e = !1, a = null, r = 0; r < this.formFields.length; r++) {
                                var n = this.formFields[r],
                                    s = n.value || "";
                                if ("string" == typeof s && (s = s.trim()), n.isRequired && 0 === s.length) {
                                    a = this.$i18n("form", "all_required_error_message"), e = !0;
                                    break
                                }
                                if ("name" === n.type) t.name = s.length ? s : void 0;
                                else if ("email" === n.type) t.email = s.length ? s : void 0;
                                else if ("phone" === n.type) s.length > 0 && (s = s.replace(/[- )(]/g, "")), t.phone = s.length ? s : void 0;
                                else if ("message" === n.type) t.message = s.length ? s : void 0;
                                else {
                                    var o;
                                    null !== (o = s) && void 0 !== o && o.length && "string" == typeof s ? n.value.length && t.additionalInfo.push({
                                        label: i.a.rawDecode(n.label),
                                        type: n.type,
                                        value: s
                                    }) : n.value.length && t.additionalInfo.push({
                                        label: i.a.rawDecode(n.label),
                                        type: n.type,
                                        value: s.join(", ")
                                    })
